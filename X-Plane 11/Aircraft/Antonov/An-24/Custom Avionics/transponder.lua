...
-- digits
defineProperty("digit_1", globalPropertyi("an-24/sq/digit_1"))
defineProperty("digit_2", globalPropertyi("an-24/sq/digit_2"))
defineProperty("digit_3", globalPropertyi("an-24/sq/digit_3"))
defineProperty("digit_4", globalPropertyi("an-24/sq/digit_4"))

-- switchers
defineProperty("emerg", globalPropertyi("an-24/sq/emerg"))
defineProperty("sq_emerg_cap", globalPropertyi("an-24/sq/sq_emerg_cap"))
defineProperty("sq_mode", globalPropertyi("an-24/sq/sq_mode"))

-- power
defineProperty("sq_sw", globalPropertyi("an-24/sq/sq_sw"))
