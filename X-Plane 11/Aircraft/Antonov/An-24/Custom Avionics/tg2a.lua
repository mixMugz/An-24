...
defineProperty("bus_DC_27_volt", globalPropertyf("an-24/power/bus_DC_27_volt")) -- power
defineProperty("temp_check", globalPropertyi("an-24/start/left_temp_check")) -- select temp check mode
...
defineProperty("uprt", globalPropertyf("an-24/misc/virt_rud1")) 
