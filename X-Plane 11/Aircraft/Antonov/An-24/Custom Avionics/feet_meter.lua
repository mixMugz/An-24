...
-- pressure value
defineProperty("pressure", globalPropertyf("an-24/gauges/feet_meter_press"))
...
-- electric
defineProperty("feet_meter_cc", globalPropertyf("an-24/gauges/feet_meter_cc")) -- gauge current consumption
...
registerCommandHandler(createCommand("An-24/Instruments/Pilot/feet_meter_on", "Feet meter on."), 0, function(p) if p == 0 and get(feet_meter_sw) ~= 1 then set(feet_meter_sw, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/feet_meter_off", "Feet meter off."), 0, function(p) if p == 0 and get(feet_meter_sw) ~= 0 then set(feet_meter_sw, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/feet_meter_toggle", "Feet meter toggle."), 0, function(p) if p == 0 then if get(feet_meter_sw) ~= 1 then set(feet_meter_sw, 1) else set(feet_meter_sw, 0) end end return 0 end)
