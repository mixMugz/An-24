...
defineProperty("mixt_valve1", globalPropertyf("an-24/fuel/fuel_access1")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
defineProperty("mixt_valve2", globalPropertyf("an-24/fuel/fuel_access2")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
defineProperty("mixt_valve3", globalPropertyf("an-24/fuel/fuel_access3")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
...
local mode_ndl_img = loadImage("fuel_panel_2d_e.dds", 6, 779, 30, 142) -- mode switcher needle
local background = {
