...
defineProperty("direction", globalPropertyi("an-24/hydro/direction")) -- gear request ( used for SmartCopilot )
...
--local gear_command_up = createCommand("an-24/gear_up", "retract landing gear landing gear")
--local gear_command_down = createCommand("an-24/gear_down", "extend landing gear landing gear")
...
local gear_move1 = loadSample('sounds/custom/gear_move.wav')
local gear_move2 = loadSample('sounds/custom/gear_move.wav')
local gear_move3 = loadSample('sounds/custom/gear_move.wav')
local gear_close1 = loadSample('sounds/custom/gear_lock.wav')
local gear_close2 = loadSample('sounds/custom/gear_lock.wav')
local gear_close3 = loadSample('sounds/custom/gear_lock.wav')
