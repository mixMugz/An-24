...
defineProperty("red_flag", loadImage("payload_panel_e.dds", 734, 22, 70, 25))
...
defineProperty("rv_sw", globalPropertyi("an-24/gauges/rv_2_sw")) 
defineProperty("rv2_cc", globalPropertyf("an-24/gauges/rv_2_cc"))  -- rv work
...
local alt_sound = loadSample('sounds/custom/altitude_alert.wav')
...
registerCommandHandler(createCommand("An-24/Instruments/Pilot/rv_on", "RV on."), 0, function(p) if p == 0 and get(rv_sw) ~= 1 then set(rv_sw, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/rv_off", "RV off."), 0, function(p) if p == 0 and get(rv_sw) ~= 0 then set(rv_sw, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/rv_toggle", "RV toggle."), 0, function(p) if p == 0 then if get(rv_sw) ~= 1 then set(rv_sw, 1) else set(rv_sw, 0) end end return 0 end)
