...
-- power
defineProperty("bus_DC_27_volt", globalPropertyf("an-24/power/bus_DC_27_volt")) -- power 27 volt
defineProperty("bus_AC_36_volt", globalPropertyf("an-24/power/bus_AC_36_volt")) -- power 36 volt
defineProperty("gpk_switch", globalPropertyf("an-24/gauges/GPK_sw"))  -- switcher to turn ON/OFF

-- fail
defineProperty("fail", globalPropertyf("sim/operation/failures/rel_cop_dgy"))

-- result
defineProperty("correct", globalPropertyf("an-24/gauges/GPK_corr")) -- correction on GPK panel
defineProperty("correct_ap", globalPropertyf("an-24/gauges/ap_GPK_corr")) -- correction on GPK panel
...
defineProperty("sc_corr_angle", globalPropertyf("an-24/gauges/sc_corr_angle")) -- SmartCopilot
