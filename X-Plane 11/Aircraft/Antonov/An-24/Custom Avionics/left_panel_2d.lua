...
defineProperty("eng_start_btn", globalPropertyi("an-24/start/eng_start_btn")) -- start selected engine
defineProperty("start_at_ground_cap", globalPropertyi("an-24/start/start_at_ground_cap")) -- select start mode cap
defineProperty("start_at_ground", globalPropertyi("an-24/start/start_at_ground")) -- select start mode
defineProperty("sel_left_right", globalPropertyi("an-24/start/sel_left_right")) -- select engine to start. -1 - left, 0 - none, +1 - right
defineProperty("eng_start_mode", globalPropertyi("an-24/start/eng_start_mode")) -- select start mode. start or fail start
defineProperty("eng_start_stop", globalPropertyi("an-24/start/eng_start_stop")) -- button for stop start process
defineProperty("left_temp_check", globalPropertyi("an-24/start/left_temp_check")) -- select temp check mode
defineProperty("left_prt24_on", globalPropertyi("an-24/start/left_prt24_on")) -- PRT24 on
defineProperty("right_temp_check", globalPropertyi("an-24/start/right_temp_check")) -- select temp check mode
defineProperty("right_prt24_on", globalPropertyi("an-24/start/right_prt24_on")) -- PRT24 on
defineProperty("ru19_air_start_btn", globalPropertyi("an-24/start/ru19_air_start_btn")) -- start at flight button
defineProperty("ru19_ground_start_btn", globalPropertyi("an-24/start/ru19_ground_start_btn")) -- start on ground button
defineProperty("ru19_ground_start_cap", globalPropertyi("an-24/start/ru19_ground_start_cap")) -- start on ground button cap
defineProperty("ru19_start_mode", globalPropertyi("an-24/start/ru19_start_mode")) -- select start mode. start or fail start
defineProperty("ru19_start_stop", globalPropertyi("an-24/start/ru19_start_stop")) -- stop button for ru19
defineProperty("ru19_start_main_sw", globalPropertyi("an-24/start/ru19_start_main_sw")) --   -- main switcher for ru19
defineProperty("ru19_start_main_sw_cap", globalPropertyi("an-24/start/ru19_start_main_sw_cap")) -- main switcher for ru19
...
defineProperty("starter_volt", globalPropertyf("an-24/start/starter_volt")) -- starter voltage for engines start
defineProperty("starter_amp", globalPropertyf("an-24/start/starter_amp")) -- starter amperage for engines start
defineProperty("apd_work_lit", globalPropertyi("an-24/start/apd_work_lit")) -- lamp for apd
-- hydro
defineProperty("main_press_angle_2d", globalPropertyf("an-24/hydro/main_press_angle"))
defineProperty("emerg_press_angle_2d", globalPropertyf("an-24/hydro/emerg_press_angle"))
defineProperty("store_press_angle_2d", globalPropertyf("an-24/hydro/store_press_angle"))
defineProperty("left_press_angle_2d", globalPropertyf("an-24/hydro/left_press_angle"))
defineProperty("right_press_angle_2d", globalPropertyf("an-24/hydro/right_press_angle"))
defineProperty("hydro_quantity_angle_2d", globalPropertyf("an-24/hydro/hydro_quantity_angle"))
defineProperty("hydro_circle", globalPropertyi("an-24/hydro/hydro_circle"))  -- connect main and emergency feeds
-- ssos
defineProperty("ssos_test", globalPropertyi("an-24/gauges/ssos_test_sw"))
defineProperty("ssos_sw", globalPropertyi("an-24/gauges/ssos_sw"))
defineProperty("ssos_sw_cap", globalPropertyi("an-24/gauges/ssos_sw_cap"))
defineProperty("ssos_power_lit", globalPropertyi("an-24/gauges/ssos_power_lit"))  -- ssos power lamp
-- ap
...
defineProperty("small_btn_dn", loadImage("fuel_panel_2d_e.dds", 181, 817, 34, 36))
defineProperty("small_btn_up", loadImage("fuel_panel_2d_e.dds", 224, 817, 34, 36))
defineProperty("yellow_cap_close", loadImage("fuel_panel_2d_e.dds", 369, 726, 44, 163))
defineProperty("yellow_cap_open", loadImage("fuel_panel_2d_e.dds", 416, 726, 44, 163))
defineProperty("red_cap_close", loadImage("fuel_panel_2d_e.dds", 272, 726, 44, 163))
defineProperty("red_cap_open", loadImage("fuel_panel_2d_e.dds", 319, 726, 44, 163))
defineProperty("red_sidecap_close", loadImage("fuel_panel_2d_e.dds", 43, 890, 162, 42))
defineProperty("red_sidecap_open", loadImage("fuel_panel_2d_e.dds", 43, 936, 162, 42))
defineProperty("ru_cap_open", loadImage("fuel_panel_2d_e.dds", 47, 805, 117, 71))
...
defineProperty("red_vent_img", loadImage("fuel_panel_2d_e.dds", 180, 726, 80, 80))
...
local ru_cap_close = {
  [0] = loadImage("fuel_panel_2d_e.dds", 47, 729, 117, 71),
        loadImage("fuel_panel_2d_r.dds", 47, 729, 117, 71),
}
local background = {
  [0] = loadImage("left_panel_2d_e.dds", 0, 0, 983, 512),
        loadImage("left_panel_2d_r.dds", 0, 0, 983, 512),
}
...
components = {
  ...
  texture {
    ...
    image = function()
      if get(ru19_ground_start_cap) == 1 then return get(ru_cap_open) else return ru_cap_close[get(language)] end
    end
  },
    switch {
