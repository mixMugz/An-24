...
defineProperty("AGB_left", globalPropertyi("an-24/gauges/AGB_left"))
defineProperty("AGD_left", globalPropertyi("an-24/gauges/AGD_left"))
defineProperty("AGD_right", globalPropertyi("an-24/gauges/AGD_right"))
defineProperty("AHZ_cc", globalPropertyf("an-24/gauges/AHZ_cc"))
defineProperty("bkk_sw", globalPropertyi("an-24/gauges/bkk_sw"))
defineProperty("bkk_sw_cap", globalPropertyi("an-24/gauges/bkk_sw_cap"))
defineProperty("bkk_check_sw", globalPropertyi("an-24/gauges/bkk_check_sw"))
defineProperty("bkk_check_sw_cap", globalPropertyi("an-24/gauges/bkk_check_sw_cap"))
...
createGlobalPropertyf("an-24/misc/ag1_pitch", 0) -- тангаж на АГ1
createGlobalPropertyf("an-24/misc/ag2_pitch", 0) -- тангаж на АГ2
createGlobalPropertyf("an-24/misc/ag3_pitch", 0) -- тангаж на АГ3
createGlobalPropertyf("an-24/misc/ag1_pitch_rot", 0) -- тангаж на АГ1
createGlobalPropertyf("an-24/misc/ag2_pitch_rot", 0) -- тангаж на АГ2
createGlobalPropertyf("an-24/misc/ag3_pitch_rot", 0) -- тангаж на АГ3
createGlobalPropertyf("an-24/misc/ag3_roll", 0) -- крен на АГ3
...
registerCommandHandler(createCommand("An-24/Instruments/Pilot/agb_left_sw_on", "AGB 1 on."), 0, function(p) if p == 0 and get(AGB_left) ~= 1 then set(AGB_left, 1) ahz_start_third = get(sim_time) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/agb_left_sw_off", "AGB 1 off."), 0, function(p) if p == 0 and get(AGB_left) ~= 0 then set(AGB_left, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/agb_left_sw_toggle", "AGB 1 toggle."), 0, function(p) if p == 0 then if get(AGB_left) == 0 then set(AGB_left, 1) ahz_start_third = get(sim_time) else set(AGB_left, 0) end end return 0 end)

registerCommandHandler(createCommand("An-24/Instruments/Pilot/agd_left_sw_on", "AGD 1 on."), 0, function(p) if p == 0 and get(AGD_left) ~= 1 then set(AGD_left, 1) ahz_start_left = get(sim_time) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/agd_left_sw_off", "AGD 1 off."), 0, function(p) if p == 0 and get(AGD_left) ~= 0 then set(AGD_left, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/agd_left_sw_toggle", "AGD 1 toggle."), 0, function(p) if p == 0 then if get(AGD_left) == 0 then set(AGD_left, 1) ahz_start_left = get(sim_time) else set(AGD_left, 0) end end return 0 end)

registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_cap_open", "BKK CAP open."), 0, function(p) if p == 0 and get(bkk_sw_cap) ~= 1 then set(bkk_sw_cap, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_cap_close", "BKK CAP close."), 0, function(p) if p == 0 and get(bkk_sw_cap) ~= 0 then set(bkk_sw_cap, 0) set(bkk_sw, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_cap_toggle", "BKK CAP toggle."), 0, function(p) if p == 0 then if get(bkk_sw_cap) ~= 1 then set(bkk_sw_cap, 1) else set(bkk_sw_cap, 0) set(bkk_sw, 1) end end return 0 end)

registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_on", "BKK on."), 0, function(p) if p == 0 and get(bkk_sw) ~= 1 then set(bkk_sw, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_off", "BKK off."), 0, function(p) if p == 0 and get(bkk_sw) ~= 0 then set(bkk_sw, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Instruments/Pilot/bkk_toggle", "BKK toggle."), 0, function(p) if p == 0 then if get(bkk_sw) ~= 1 then set(bkk_sw, 1) else set(bkk_sw, 0) end end return 0 end)
