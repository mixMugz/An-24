...
defineProperty("int_cutoff", globalPropertyf("an-24/sound/interier_cutoff"))  -- cutoff detector
...
defineProperty("cabin_hatch", globalPropertyf("an-24/lukbesson"))  -- open/close cabin hatch
