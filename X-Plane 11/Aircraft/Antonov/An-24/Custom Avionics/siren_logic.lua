defineProperty("siren_flaps", globalPropertyi("an-24/gauges/flaps_siren"))
defineProperty("siren_auasp", globalPropertyi("an-24/gauges/auasp_warning"))
defineProperty("siren_ssos", globalPropertyi("an-24/gauges/ssos_warning"))
defineProperty("siren_fire", globalPropertyi("an-24/fire/fire_warinig"))
defineProperty("siren_gears", globalPropertyi("an-24/gauges/gear_siren"))
defineProperty("skv_siren", globalPropertyi("an-24/skv/skv_siren")) 
defineProperty("skv_siren_alarm", globalPropertyi("an-24/skv/skv_siren_alarm")) 

defineProperty("siren_armed", globalPropertyf("sim/cockpit/weapons/guns_armed"))
defineProperty("frame_time", globalPropertyf("an-24/time/frame_time")) -- time between frames
