...
defineProperty("fire_valve1", globalPropertyf("an-24/fuel/fire_valve1")) -- fire valve for engine 1
defineProperty("fire_valve2", globalPropertyf("an-24/fuel/fire_valve2")) -- fire valve for engine 2
defineProperty("fire_valve3", globalPropertyf("an-24/fuel/fire_valve3")) -- fire valve for engine 3
...
defineProperty("auto_ff", globalPropertyi("an-24/fuel/auto_ff")) -- automatic fuel flow
defineProperty("fuel_q_meter1", globalPropertyi("an-24/fuel/q_meter1_switch")) -- switcher for fuel meter 1
defineProperty("fuel_q_meter2", globalPropertyi("an-24/fuel/q_meter2_switch")) -- switcher for fuel meter 2
defineProperty("ff_meter", globalPropertyi("an-24/fuel/ff_meter_switch")) -- switcher for fuel flow meter 1
...
defineProperty("fuel_circle_cc", globalPropertyf("an-24/fuel/fuel_circle_cc")) -- fuel valves current consumption
