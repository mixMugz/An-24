...
-- power
defineProperty("bus27", globalPropertyf("an-24/power/bus_DC_27_volt_emerg"))
defineProperty("bus115", globalPropertyf("an-24/power/bus_AC_115_volt"))
defineProperty("ark_cc", globalPropertyf("an-24/ark/ark1_cc"))
...
-- result
defineProperty("res_angle", globalPropertyf("an-24/ark/ark1_angle"))
defineProperty("res_signal", globalPropertyf("an-24/ark/ark1_signal"))
...
function file_read()
	local filename
	if get(dev_num) == 0 then filename = panelDir .. "/an-24_ark1.ini" else filename = panelDir .. "/an-24_ark2.ini" end -- define file by device number
