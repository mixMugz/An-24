...
defineProperty("ark_need_freq", globalPropertyi("an-24/ark/ark1_need_freq"))
defineProperty("ark_band_need", globalPropertyi("an-24/ark/ark1_band_need"))
defineProperty("ark_tune_need", globalPropertyi("an-24/ark/ark1_tune_need"))
defineProperty("ark_fine_tune_need", globalPropertyi("an-24/ark/ark1_fine_tune_need"))
defineProperty("audio_selection", globalPropertyi("sim/cockpit2/radios/actuators/audio_selection_adf1"))
defineProperty("cw_sw", globalPropertyi("an-24/ark/ark1_cw"))
defineProperty("button", globalPropertyi("an-24/ark/ark1_button"))
defineProperty("ark_mode", globalPropertyi("an-24/ark/ark1_mode"))
defineProperty("ark_band", globalPropertyi("an-24/ark/ark1_band"))
defineProperty("band_fix", globalPropertyi("an-24/ark/ark1_band_fix"))
defineProperty("ark_tune", globalPropertyi("an-24/ark/ark1_tune"))
defineProperty("tune_fix", globalPropertyi("an-24/ark/ark1_tune_fix"))
defineProperty("ark_fine_tune", globalPropertyi("an-24/ark/ark1_fine_tune"))
defineProperty("ant_sw", globalPropertyi("an-24/ark/ark1_ant_sw"))
-- images
...
-- buttons
defineProperty("butP", loadImage("radio_panel_2d_e.dds", 2, 693, 30, 30))
defineProperty("but1", loadImage("radio_panel_2d_e.dds", 31, 693, 30, 30))
defineProperty("but2", loadImage("radio_panel_2d_e.dds", 60, 693, 30, 30))
defineProperty("but3", loadImage("radio_panel_2d_e.dds", 90, 693, 30, 30))
defineProperty("but4", loadImage("radio_panel_2d_e.dds", 120, 693, 30, 30))
defineProperty("but5", loadImage("radio_panel_2d_e.dds", 150, 693, 30, 30))
defineProperty("but6", loadImage("radio_panel_2d_e.dds", 180, 693, 30, 30))
defineProperty("but7", loadImage("radio_panel_2d_e.dds", 210, 693, 30, 30))
defineProperty("but8", loadImage("radio_panel_2d_e.dds", 240, 693, 30, 30))
defineProperty("but9", loadImage("radio_panel_2d_e.dds", 270, 693, 30, 30))
-- knobs
defineProperty("rot_switch", loadImage("rot_switch.dds"))
defineProperty("knob_close", loadImage("radio_panel_2d_e.dds", 0, 745, 116, 116))
defineProperty("knob_open", loadImage("radio_panel_2d_e.dds", 132, 745, 116, 116))
defineProperty("knob_simple", loadImage("radio_panel_2d_e.dds", 260, 745, 116, 116))
-- tumbler
