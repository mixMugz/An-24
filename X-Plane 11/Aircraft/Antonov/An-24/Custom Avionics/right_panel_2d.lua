...
defineProperty("wind_ht_sw2", globalPropertyi("an-24/ice/window_ht_sw2"))   -- window heat copilot
...
-- GPK panel
defineProperty("lat", globalPropertyf("an-24/gauges/GPK_lat")) -- latitude position on panel
defineProperty("lat_angle", globalPropertyf("an-24/gauges/GPK_lat_rotary")) -- angle for lat rotary
defineProperty("corr_switcher", globalPropertyi("an-24/gauges/GPK_corr_sw")) -- correction switcher ON/OFF
defineProperty("corr_rot", globalPropertyi("an-24/gauges/GPK_corr_rot")) -- correction rotary
-- skv
defineProperty("bleed1_sw", globalPropertyi("an-24/skv/bleed1_sw"))
defineProperty("bleed2_sw", globalPropertyi("an-24/skv/bleed2_sw"))
...
defineProperty("lat_rotary_img", loadImage("right_panel_2d_e.dds", 856, 8, 98, 98))
...
defineProperty("prop_up_img", loadImage("right_panel_2d_e.dds", 831, 117, 66, 66))
defineProperty("prop_ctr_img", loadImage("right_panel_2d_e.dds", 831, 188, 66, 66))
defineProperty("prop_dn_img", loadImage("right_panel_2d_e.dds", 831, 259, 66, 66))

local language = globalPropertyi("an-24/set/language")
local background = {
  [0] = loadImage("right_panel_2d_e.dds", 0, 0, size[1], size[2]),
        loadImage("right_panel_2d_r.dds", 0, 0, size[1], size[2]),
}
...
components = {
  ...
  -- windows heat switch
    switch {
        position = { 10, 5, 25, 80},
        state = function()
            return get(wind_ht_sw2) ~= 0
        end,
        btnOn = get(tmb_up),
        btnOff = get(tmb_dn),
        onMouseClick = function()
            if get(wind_ht_sw2) ~= 0 then
                set(wind_ht_sw2, 0)
            else
                set(wind_ht_sw2, 1)
            end
