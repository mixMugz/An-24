...
-- switchers
defineProperty("rudd_sw", globalPropertyi("an-24/trimm/rudd_sw")) -- rudder switch position
defineProperty("ail_sw", globalPropertyi("an-24/trimm/ail_sw")) -- rudder switch position
