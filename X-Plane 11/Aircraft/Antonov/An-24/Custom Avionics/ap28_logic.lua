...
defineProperty("indicated_roll", globalPropertyf("an-24/ap/indicated_roll"))  -- roll from AHZ
defineProperty("indicated_pitch", globalPropertyf("an-24/ap/indicated_pitch"))  -- pitch from AHZ
defineProperty("curse_gik", globalPropertyf("an-24/ap/curse_gik"))  -- curse diff from GIK gauge
defineProperty("curse_gpk", globalPropertyf("an-24/ap/curse_gpk"))  -- curse diff from GPK gauge
defineProperty("curse_zk", globalPropertyf("an-24/ap/curse_zk"))  -- curse diff from ZK2 gauge
...
defineProperty("pitch_force", globalPropertyf("an-24/ap/ap_pitch_comm"))
...
defineProperty("ap_pitch", globalPropertyi("an-24/ap/ap_pitch"))  -- pitch control UP and DOWN
...
-- controls
defineProperty("ap_roll_diff", globalPropertyf("an-24/ap/ap_roll_diff"))  -- difference between needed and current roll (bank)
defineProperty("ap_pitch_diff", globalPropertyf("an-24/ap/ap_pitch_diff"))  -- difference between needed and current pitch
defineProperty("ap_hdg_diff", globalPropertyf("an-24/ap/ap_hdg_diff"))  -- difference between needed and current heading
defineProperty("ap_roll_power", globalPropertyi("an-24/ap/ap_roll_power"))  -- power for aileron mechanic
defineProperty("ap_pitch_power", globalPropertyi("an-24/ap/ap_pitch_power"))  -- power for elevator mechanic
defineProperty("ap_hdg_power", globalPropertyi("an-24/ap/ap_hdg_power"))  -- power for rudder mechanic
defineProperty("yaw_spd", globalPropertyf("an-24/ap/ap_yaw_spd")) -- current yaw speed deg/sec
