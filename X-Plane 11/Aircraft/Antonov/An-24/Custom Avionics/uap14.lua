...
defineProperty("auasp_button", globalPropertyi("an-24/gauges/auasp_button"))  -- check button
defineProperty("aoa_sensor_angle", globalPropertyf("an-24/misc/aoa_sensor_angle"))  -- angle of AOA sensor

-- power
defineProperty("auasp_sw", globalPropertyi("an-24/gauges/auasp_sw"))  -- power switcher
defineProperty("auasp_cc", globalPropertyf("an-24/gauges/auasp_cc"))  -- power current
