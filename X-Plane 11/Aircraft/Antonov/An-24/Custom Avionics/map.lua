...
-- texture table
defineProperty("num_1", loadImage("map_cover_e.dds", 379, 7, 32, 13))
defineProperty("num_2", loadImage("map_cover_e.dds", 379, 26, 32, 13))
defineProperty("num_3", loadImage("map_cover_e.dds", 379, 46, 32, 13))
defineProperty("num_4", loadImage("map_cover_e.dds", 379, 66, 32, 13))
defineProperty("num_5", loadImage("map_cover_e.dds", 379, 86, 32, 13))
defineProperty("size_025", loadImage("map_cover_e.dds", 379, 107, 32, 13))
defineProperty("size_05", loadImage("map_cover_e.dds", 379, 125, 32, 13))
defineProperty("size_1", loadImage("map_cover_e.dds", 379, 144, 32, 13))
defineProperty("size_2", loadImage("map_cover_e.dds", 379, 164, 32, 13))
defineProperty("size_4", loadImage("map_cover_e.dds", 379, 185, 32, 13))
