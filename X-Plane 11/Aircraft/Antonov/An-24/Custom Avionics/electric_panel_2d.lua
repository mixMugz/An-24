...
defineProperty("stg1_on", globalPropertyi("an-24/power/stg1_on")) -- generator connected if 1 and dissconnected if 0
defineProperty("stg2_on", globalPropertyi("an-24/power/stg2_on"))

defineProperty("stg1_on_bus", globalPropertyi("an-24/power/stg1_on_bus"))  -- generator connected if 1 and dissconnected if 0
defineProperty("stg2_on_bus", globalPropertyi("an-24/power/stg2_on_bus"))
defineProperty("gs24_on_bus", globalPropertyi("an-24/power/gs24_on_bus"))
defineProperty("go1_on_bus", globalPropertyi("an-24/power/go1_on_bus"))
defineProperty("go2_on_bus", globalPropertyi("an-24/power/go2_on_bus"))
...
defineProperty("inv_PT750", globalPropertyi("an-24/power/inv_PT750"))

defineProperty("bat1_on", globalPropertyi("an-24/power/bat1_on"))  -- battery switch. 0 = OFF, 1 = ON
defineProperty("bat2_on", globalPropertyi("an-24/power/bat2_on"))
defineProperty("bat3_on", globalPropertyi("an-24/power/bat3_on"))
...
defineProperty("stg1_volt", globalPropertyf("an-24/power/stg1_volt")) -- generators voltage.
defineProperty("stg2_volt", globalPropertyf("an-24/power/stg2_volt"))
defineProperty("gs24_volt", globalPropertyf("an-24/power/gs24_volt"))
defineProperty("go1_volt", globalPropertyf("an-24/power/go1_volt"))
defineProperty("go2_volt", globalPropertyf("an-24/power/go2_volt"))

defineProperty("stg1_amp", globalPropertyf("an-24/power/stg1_amp")) -- generators current, initial 0A
defineProperty("stg2_amp", globalPropertyf("an-24/power/stg2_amp"))
defineProperty("gs24_amp", globalPropertyf("an-24/power/gs24_amp"))
defineProperty("go1_amp", globalPropertyf("an-24/power/go1_amp"))
defineProperty("go2_amp", globalPropertyf("an-24/power/go2_amp"))

defineProperty("bat1_volt", globalPropertyf("an-24/power/bat1_volt")) -- battery voltage, initial 27V - full charge.
defineProperty("bat2_volt", globalPropertyf("an-24/power/bat2_volt"))
defineProperty("bat3_volt", globalPropertyf("an-24/power/bat3_volt"))

defineProperty("bat1_amp", globalPropertyf("an-24/power/bat1_amp"))  -- battery current, initial 0A. positive - battery load, negative - battery recharge.
defineProperty("bat2_amp", globalPropertyf("an-24/power/bat2_amp"))
defineProperty("bat3_amp", globalPropertyf("an-24/power/bat3_amp"))

defineProperty("bat_all_amp", globalPropertyf("an-24/power/bat_all_amp"))  -- overall load of batteries
defineProperty("bat_all_volt", globalPropertyf("an-24/power/bat_all_volt"))  -- overall voltage of batteries
...
defineProperty("bus_DC_27_amp", globalPropertyf("an-24/power/bus_DC_27_amp"))
...
-- switchers
defineProperty("AC36_volt_mode", globalPropertyi("an-24/power/AC36_volt_mode"))  -- mode switcher for AC 36 voltmeter, 9 positions 0-8
defineProperty("AC115_volt_mode", globalPropertyi("an-24/power/AC115_volt_mode"))  -- mode switcher for AC 115 voltmeter, 7 positions 0-6
defineProperty("DC_volt_mode", globalPropertyi("an-24/power/DC_volt_mode"))  -- mode switcher for DC voltmeter, 11 positions 0-10
defineProperty("PT1000_mode", globalPropertyi("an-24/power/PT1000_mode"))   -- switcher for PT1000. 0 = emerg, 1 = off, 2 = on
defineProperty("PO750_mode", globalPropertyi("an-24/power/PO750_mode"))  -- switcher for PO750. 0 = ground, 1 = off, 2 = on
defineProperty("GS24_mode", globalPropertyi("an-24/power/GS24_mode"))  -- start from: 0 = ground power, 1 = off, 2 = GS24
defineProperty("power_mode", globalPropertyi("an-24/power/power_mode"))  -- power mode: 0 = Ground, 1 = off, 2 = airplane
defineProperty("emerg_mode", globalPropertyi("an-24/power/emerg_mode"))  -- switcher for emergency power. 0 = auto, 1 = on main bus, 2 = emergency bus only
defineProperty("STG_disconnect_cap1", globalPropertyi("an-24/power/STG_disconnect_cap1"))  -- red cap for STG disconnectiong button
defineProperty("STG_disconnect_cap2", globalPropertyi("an-24/power/STG_disconnect_cap2"))  -- red cap for STG disconnectiong button
defineProperty("emerg_cap", globalPropertyf("an-24/power/emerg_cap"))  -- red cap for emergency mode switcher

-- logic
defineProperty("ground_available", globalPropertyi("an-24/power/ground_available")) -- ground power available
...
defineProperty("btn_press", loadImage("electro_panel_2d_e.dds", 130, 895, 25, 25))
defineProperty("btn_up", loadImage("electro_panel_2d_e.dds", 171, 895, 25, 25))
defineProperty("stg_cap_close", loadImage("electro_panel_2d_e.dds", 4, 879, 50, 81))
defineProperty("stg_cap_open", loadImage("electro_panel_2d_e.dds", 55, 879, 50, 81))
defineProperty("main_cap_open", loadImage("electro_panel_2d_e.dds", 207, 873, 82, 104))
defineProperty("main_tmb_up", loadImage("electro_panel_2d_e.dds", 115, 967, 24, 43))
defineProperty("main_tmb_ctr", loadImage("electro_panel_2d_e.dds", 145, 967, 24, 43))
defineProperty("main_tmb_dn", loadImage("electro_panel_2d_e.dds", 180, 966, 24, 43))
defineProperty("main_tmb_up_close", loadImage("electro_panel_2d_e.dds", 412, 877, 50, 103))
defineProperty("main_tmb_ctr_close", loadImage("electro_panel_2d_e.dds", 359, 877, 50, 103))
