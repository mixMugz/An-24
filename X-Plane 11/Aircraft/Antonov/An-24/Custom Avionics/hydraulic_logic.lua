...
defineProperty("frontgear_use_hydro", globalPropertyi("an-24/hydro/frontgear_use_hydro")) -- front gear steering manipulates by hydraulic system
...
-- power calculations
defineProperty("pump_cc", globalPropertyf("an-24/hydro/pump_cc")) -- emergency pump consumption
