...
defineProperty("auasp_warn", globalPropertyi("an-24/gauges/auasp_warning"))  -- warning from AUASP
defineProperty("rv2_cc", globalPropertyf("an-24/gauges/rv_2_cc"))  -- rv work
defineProperty("ssos_warning", globalPropertyi("an-24/gauges/ssos_warning"))  -- warning from SSOS
...
local warning_img = {
  [0] = loadImage("lamps_e.dds", 100, 30, 50, 30),
        loadImage("lamps_r.dds", 100, 30, 50, 30),
}
...
components = {
  ...
  textureLit {
    ...
    image = function()
      return warning_img[get(language)]
    end,
    visible = function()
      return lamp_vis
    end
