...
defineProperty("vert_plank", loadImage("payload_panel_e.dds", 719, 5, 2, 100))
defineProperty("hor_plank_green", loadImage("payload_panel_e.dds", 730, 2, 100, 2))
defineProperty("hor_plank_orange", loadImage("payload_panel_e.dds", 730, 8, 100, 2))
...
local bg = {
  [0] = loadImage("payload_panel_e.dds", 5, 3, size[1], size[2]),
        loadImage("payload_panel_r.dds", 5, 3, size[1], size[2]),
}
...
function update()
  ...
  set_flags()
  set(crew,(crew_weight / 80) * get(extview))
end
