...
-- add map textures
--defineProperty("ruler1", loadImage("nl10m_e.dds", 0, 0, 2048, 300))
--defineProperty("ruler2", loadImage("nl10m_e.dds", 0, 296, 2048, 300))
--defineProperty("slider1", loadImage("nl10m_e.dds", 0, 638, 2048, 145))
--defineProperty("slider2", loadImage("nl10m_e.dds", 0, 806, 2048, 145))
--defineProperty("visir_img", loadImage("fuel_panel_2d_e.dds", 502, 723, 10, 300))

local language = globalPropertyi("an-24/set/language")
local lang = 0
local change_side_img = loadImage("fuel_panel_2d_e.dds", 0, 1000, 132, 23)
local ruler1 = {
  [0] = loadImage("nl10m_e.dds", 0, 0, 2048, 300),
        loadImage("nl10m_r.dds", 0, 0, 2048, 300),
}
local ruler2 = {
  [0] = loadImage("nl10m_e.dds", 0, 296, 2048, 300),
        loadImage("nl10m_r.dds", 0, 296, 2048, 300),
}
local slider1 = {
  [0] = loadImage("nl10m_e.dds", 0, 638, 2048, 145),
        loadImage("nl10m_r.dds", 0, 638, 2048, 145),
}
local slider2 = {
  [0] = loadImage("nl10m_e.dds", 0, 806, 2048, 145),
        loadImage("nl10m_r.dds", 0, 806, 2048, 145),
}

-- vars for textures
local side = 0
local background_img = ruler1[lang]
local bar_img = slider1[lang]
-- movement
...
function update()
  ...
  -- define side texture
  if side == 0 then
    background_img = ruler1[lang]
    bar_img = slider1[lang]
  else
    background_img = ruler2[lang]
    bar_img = slider2[lang]
  end
