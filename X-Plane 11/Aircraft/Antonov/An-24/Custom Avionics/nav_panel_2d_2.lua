...
defineProperty("vent_1_sw", globalPropertyi("an-24/misc/vent_1_sw"))
...
local background = {
  [0] = loadImage("navigator_panel_2d_e.dds", 532, 0, 493, 687),
        loadImage("navigator_panel_2d_r.dds", 532, 0, 493, 687),
}
