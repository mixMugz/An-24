...
defineProperty("GIK_sw", globalPropertyi("an-24/gauges/GIK_sw")) 

-- control
defineProperty("GIK_button", globalPropertyi("an-24/gauges/GIK_button")) 
defineProperty("GIK_curse", globalPropertyf("an-24/gauges/GIK_curse"))
defineProperty("ap_GIK_curse", globalPropertyf("an-24/ap/curse_gik"))

-- sources
defineProperty("gyro", globalPropertyf("an-24/gauges/gyro_curse"))
...
defineProperty("sc_angle", globalPropertyf("an-24/gauges/sc_angle")) -- SmartCopilot
defineProperty("sc_ap_angle", globalPropertyf("an-24/gauges/sc_ap_angle")) -- SmartCopilot
