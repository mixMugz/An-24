...
size = {2048, 2048}
defineProperty("fire_valve1_sw", globalPropertyi("an-24/fuel/fire_valve1_sw")) -- fire valve switch for engine 1
defineProperty("fire_valve2_sw", globalPropertyi("an-24/fuel/fire_valve2_sw")) -- fire valve switch for engine 2
defineProperty("fire_valve3_sw", globalPropertyi("an-24/fuel/fire_valve3_sw")) -- fire valve switch for engine 3
defineProperty("fuel_circle_valve_sw", globalPropertyi("an-24/fuel/fuel_circle_valve_sw")) -- valve for fuel circulation between left and right tanks
defineProperty("pump1_switch", globalPropertyi("an-24/fuel/pump1_switch"))  -- fuel pump switch tank 1
defineProperty("pump2_switch", globalPropertyi("an-24/fuel/pump2_switch"))  -- fuel pump switch tank 2
defineProperty("pump3_switch", globalPropertyi("an-24/fuel/pump3_switch"))  -- fuel pump switch tank 3
defineProperty("pump4_switch", globalPropertyi("an-24/fuel/pump4_switch"))  -- fuel pump switch tank 4
defineProperty("q_meter1_switch", globalPropertyi("an-24/fuel/q_meter1_switch"))  -- switcher for quantity meter left
defineProperty("q_meter2_switch", globalPropertyi("an-24/fuel/q_meter2_switch"))  -- switcher for quantity meter right
defineProperty("ff_meter_switch", globalPropertyi("an-24/fuel/ff_meter_switch"))  -- switcher for fuel flow meter
defineProperty("auto_ff_switch", globalPropertyi("an-24/fuel/auto_ff_switch"))  -- switcher for fuel flow automat
defineProperty("quantity_mode", globalPropertyi("an-24/fuel/quantity_mode"))  -- mode of quantity meter
defineProperty("fuel_stop1", globalPropertyf("an-24/fuel/fuel_stop1")) -- stops on center panel
defineProperty("fuel_stop2", globalPropertyf("an-24/fuel/fuel_stop2")) -- stops on center panel
defineProperty("fuel_stop1_cap", globalPropertyf("an-24/fuel/fuel_stop1_cap")) -- stops on center panel
defineProperty("fuel_stop2_cap", globalPropertyf("an-24/fuel/fuel_stop2_cap")) -- stops on center panel
defineProperty("fuel_pump_1", globalPropertyi("an-24/fuel/tank1_pump"))  -- fuel pump for tank 1
defineProperty("fuel_pump_2", globalPropertyi("an-24/fuel/tank2_pump"))  -- fuel pump for tank 2
defineProperty("fuel_pump_3", globalPropertyi("an-24/fuel/tank3_pump"))  -- fuel pump for tank 3
defineProperty("fuel_pump_4", globalPropertyi("an-24/fuel/tank4_pump"))  -- fuel pump for tank 4
defineProperty("fuel_circle_valve", globalPropertyi("an-24/fuel/fuel_circle_valve")) -- valve for fuel circulation between left and right tanks
defineProperty("mixt_valve1", globalPropertyf("an-24/fuel/fire_valve1")) -- fire valve for engine 1
defineProperty("mixt_valve2", globalPropertyf("an-24/fuel/fire_valve2")) -- fire valve for engine 2
defineProperty("mixt_valve3", globalPropertyf("an-24/fuel/fire_valve3")) -- fire valve for engine 3
...
defineProperty("tank1_q_ind", globalPropertyf("an-24/fuel/tank1_q_ind")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
defineProperty("tank2_q_ind", globalPropertyf("an-24/fuel/tank2_q_ind")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
defineProperty("tank3_q_ind", globalPropertyf("an-24/fuel/tank3_q_ind")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
defineProperty("tank4_q_ind", globalPropertyf("an-24/fuel/tank4_q_ind")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
...
defineProperty("bus_AC_36_volt", globalPropertyf("an-24/power/bus_AC_36_volt"))
...
defineProperty("quant_1000_lit", globalPropertyi("an-24/fuel/quant_1000_lit")) --
defineProperty("left_filter_block_lit", globalPropertyi("an-24/fuel/left_filter_block_lit")) --
defineProperty("right_filter_block_lit", globalPropertyi("an-24/fuel/right_filter_block_lit")) --
defineProperty("fuel_circle_lit", globalPropertyi("an-24/fuel/fuel_circle_lit")) --
defineProperty("left_fuel_press_lit", globalPropertyi("an-24/fuel/left_fuel_press_lit")) --
defineProperty("right_fuel_press_lit", globalPropertyi("an-24/fuel/right_fuel_press_lit")) --
defineProperty("left_pk_open_lit", globalPropertyi("an-24/fuel/left_pk_open_lit")) --
defineProperty("right_pk_open_lit", globalPropertyi("an-24/fuel/right_pk_open_lit")) --
defineProperty("left_chip_lit", globalPropertyi("an-24/fuel/left_chip_lit")) --
defineProperty("right_chip_lit", globalPropertyi("an-24/fuel/right_chip_lit")) --
defineProperty("fuel_lump1_lit", globalPropertyi("an-24/fuel/fuel_lump1_lit")) --
defineProperty("fuel_lump2_lit", globalPropertyi("an-24/fuel/fuel_lump2_lit")) --
defineProperty("fuel_lump3_lit", globalPropertyi("an-24/fuel/fuel_lump3_lit")) --
defineProperty("fuel_lump4_lit", globalPropertyi("an-24/fuel/fuel_lump4_lit")) --
defineProperty("fuel_flow_left_angle", globalPropertyf("an-24/fuel/fuel_flow_left_angle")) --
defineProperty("fuel_flow_right_angle", globalPropertyf("an-24/fuel/fuel_flow_right_angle")) --
defineProperty("fuel_flow_left_count", globalPropertyf("an-24/fuel/fuel_flow_left_count")) --
defineProperty("fuel_flow_right_count", globalPropertyf("an-24/fuel/fuel_flow_right_count")) --
defineProperty("fuel_flow_left_count_rot", globalPropertyf("an-24/fuel/fuel_flow_left_count_rot")) --
defineProperty("fuel_flow_right_count_rot", globalPropertyf("an-24/fuel/fuel_flow_right_count_rot")) --
defineProperty("fuel_quant1_angle", globalPropertyf("an-24/fuel/fuel_quant1_angle")) --
defineProperty("fuel_quant2_angle", globalPropertyf("an-24/fuel/fuel_quant2_angle")) --
defineProperty("fuel_quant_button", globalPropertyi("an-24/fuel/fuel_quant_button")) --
defineProperty("ru19_pk_open_lit", globalPropertyi("an-24/fuel/ru19_pk_open_lit")) --
defineProperty("ru19_pk_close_lit", globalPropertyi("an-24/fuel/ru19_pk_close_lit")) --
...
registerCommandHandler(createCommand("An-24/Fuel/fg_left_sw_on", "Fuel gauge left on."), 0, function(p) if p == 0 and get(q_meter1_switch) ~= 1 then set(q_meter1_switch, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/fg_left_sw_off", "Fuel gauge left off."), 0, function(p) if p == 0 and get(q_meter1_switch) ~= 0 then set(q_meter1_switch, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/fg_left_sw_toggle", "Fuel gauge left toggle."), 0, function(p) if p == 0 then if get(q_meter1_switch) == 0 then set(q_meter1_switch, 1) else set(q_meter1_switch, 0) end end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/fg_right_sw_on", "Fuel gauge right on."), 0, function(p) if p == 0 and get(q_meter2_switch) ~= 1 then set(q_meter2_switch, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/fg_right_sw_off", "Fuel gauge right off."), 0, function(p) if p == 0 and get(q_meter2_switch) ~= 0 then set(q_meter2_switch, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/fg_right_sw_toggle", "Fuel gauge right toggle."), 0, function(p) if p == 0 then if get(q_meter2_switch) == 0 then set(q_meter2_switch, 1) else set(q_meter2_switch, 0) end end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/ff_meter_sw_on", "Fuel flow meter on."), 0, function(p) if p == 0 and get(ff_meter_switch) ~= 1 then set(ff_meter_switch, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/ff_meter_sw_off", "Fuel flow meter off."), 0, function(p) if p == 0 and get(ff_meter_switch) ~= 0 then set(ff_meter_switch, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/ff_meter_sw_toggle", "Fuel flow meter toggle."), 0, function(p) if p == 0 then if get(ff_meter_switch) == 0 then set(ff_meter_switch, 1) else set(ff_meter_switch, 0) end end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/auto_ff_sw_on", "Automatic fuel flow on."), 0, function(p) if p == 0 and get(auto_ff_switch) ~= 1 then set(auto_ff_switch, 1) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/auto_ff_sw_off", "Automatic fuel flow off."), 0, function(p) if p == 0 and get(auto_ff_switch) ~= 0 then set(auto_ff_switch, 0) end return 0 end)
registerCommandHandler(createCommand("An-24/Fuel/auto_ff_sw_toggle", "Automatic fuel flow toggle."), 0, function(p) if p == 0 then if get(auto_ff_switch) == 0 then set(auto_ff_switch, 1) else set(auto_ff_switch, 0) end end return 0 end)
