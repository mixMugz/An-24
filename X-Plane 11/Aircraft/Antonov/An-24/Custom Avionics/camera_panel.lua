...
defineProperty("swview", globalPropertyi("an-24/view/switch_view"))

local language = globalPropertyi("an-24/set/language")

local bg = {
  [0] = loadImage("camera_e.png"),
        loadImage("camera_r.png"),
}
...
function draw()
  drawTexture(bg[get(language)], 0, 0, size[1], size[2], 1, 1, 1)
end