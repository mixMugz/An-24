...
defineProperty("adf2_meter", globalPropertyf("an-24/ark/ark2_signal"))
defineProperty("ark1_mode", globalPropertyi("an-24/ark/ark1_mode"))
defineProperty("ark2_mode", globalPropertyi("an-24/ark/ark2_mode"))
...
defineProperty("dst2", globalPropertyf("an-24/nas1/E_needle"))
defineProperty("counter", globalPropertyf("an-24/nas1/counter"))
defineProperty("mode1", globalPropertyf("an-24/nas1/mode1"))
defineProperty("mode2", globalPropertyf("an-24/nas1/mode2"))
defineProperty("map_angle", globalPropertyf("an-24/nas1/map_angle"))
defineProperty("water", globalPropertyf("an-24/nas1/water"))
...
elseif ( get(kln90b_pri) == 1 or get(gns430_pri) == 1 ) and currtype ~= 1 and get(GPS_name) == currident then
...
if get(gns430_pri) == 1 or get(kln90b_pri) == 1 then
...
if get(gns430_pri) == 0 and get(kln90b_pri) == 0 then
handle_gps = 0
end
