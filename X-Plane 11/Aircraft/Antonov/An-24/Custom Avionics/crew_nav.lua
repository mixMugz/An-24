...
defineProperty("radioalt", globalPropertyf("an-24/gauges/radioalt"))
...
defineProperty("radioalt_dh", globalPropertyi("an-24/gauges/radioalt_dh")) -- radio altitude is decision height
