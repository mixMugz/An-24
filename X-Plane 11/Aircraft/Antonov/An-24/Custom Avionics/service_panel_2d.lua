...
defineProperty("antiice_left", globalPropertyi("an-24/covers/antiice_left"))  -- left anti-ice detector cover
defineProperty("antiice_right", globalPropertyi("an-24/covers/antiice_right"))  -- right anti-ice detector cover
defineProperty("rockets", globalPropertyi("an-24/covers/rockets"))  -- rockets cover
defineProperty("pitot_1", globalPropertyi("an-24/covers/pitot_1"))  -- pitot 1
defineProperty("pitot_2", globalPropertyi("an-24/covers/pitot_2"))  -- pitot 2
defineProperty("pitot_3", globalPropertyi("an-24/covers/pitot_3"))  -- pitot 3
defineProperty("grounding", globalPropertyi("an-24/covers/grounding"))  -- grounding wire
...
defineProperty("cabin_hatch", globalPropertyi("an-24/lukbesson_switch"))  -- open/close cabin hatch
...
defineProperty("ground_sound", globalPropertyi("an-24/sound/gndsound"))
...
defineProperty("cabin_hatch_stat", globalPropertyf("an-24/lukbesson"))  -- open/close cabin hatch
