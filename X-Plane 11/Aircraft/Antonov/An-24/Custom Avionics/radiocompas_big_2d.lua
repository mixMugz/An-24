...
createGlobalPropertyf("an-24/misc/ushdb_2_scale_angle", 0) -- поворот шкалы на УШДБ
createGlobalPropertyf("an-24/misc/ushdb_2_scale_dir", 0) -- направление поворота шкалы на УШДБ

defineProperty("ushdb_1_scale_angle", globalPropertyf("an-24/misc/ushdb_1_scale_angle")) -- поворот шкалы на УШДБ
defineProperty("ushdb_1_scale_dir", globalPropertyf("an-24/misc/ushdb_1_scale_dir")) -- поворот шкалы на УШДБ
-- SmartCopilot
