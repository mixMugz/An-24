size = {2048, 2048}
-- define dataref
defineProperty("auasp_warn", globalPropertyi("an-24/gauges/auasp_warning"))  -- warning
...
defineProperty("oil_lamp1", globalPropertyf("an-24/gauges/oil_lamp1")) -- low quantity lamp
defineProperty("oil_lamp2", globalPropertyf("an-24/gauges/oil_lamp2")) -- low quantity lamp
...
local critical_mode = {
  [0] = loadImage("lamps_e.dds", 50, 30, 50, 30),
        loadImage("lamps_r.dds", 50, 30, 50, 30),
}
...
components = {
  ...
  textureLit {
    ...
    image = function()
      return critical_mode[get(language)]
    end,
    visible = function()
      return auasp_light
    end
