...
defineProperty("rsbn_channel", globalPropertyi("an-24rv/rsbn/channel"))
defineProperty("rsbn_receive", globalPropertyi("an-24rv/rsbn/receive"))
defineProperty("rsbn_lat", globalPropertyf("an-24rv/rsbn/lat"))
defineProperty("rsbn_lon", globalPropertyf("an-24rv/rsbn/lon"))
defineProperty("rsbn_elev", globalPropertyf("an-24rv/rsbn/elev"))
