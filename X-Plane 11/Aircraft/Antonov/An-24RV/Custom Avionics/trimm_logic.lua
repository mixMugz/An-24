...
-- switchers
defineProperty("rudd_sw", globalPropertyi("an-24rv/trimm/rudd_sw")) -- rudder switch position
defineProperty("ail_sw", globalPropertyi("an-24rv/trimm/ail_sw")) -- rudder switch position
