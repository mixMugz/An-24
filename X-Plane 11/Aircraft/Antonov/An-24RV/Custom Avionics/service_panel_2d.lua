...
defineProperty("left_eng_main", globalPropertyi("an-24rv/covers/left_eng_main"))  -- left engine main cover
defineProperty("left_eng_ext", globalPropertyi("an-24rv/covers/left_eng_ext"))  -- left engine exhaust cover
defineProperty("right_eng_main", globalPropertyi("an-24rv/covers/right_eng_main"))  -- right engine main cover
defineProperty("right_eng_ext", globalPropertyi("an-24rv/covers/right_eng_ext"))  -- right engine exhaust cover
defineProperty("ru19_eng_ext", globalPropertyi("an-24rv/covers/ru19_eng_ext"))  -- ru19 engine exhaust cover
defineProperty("antiice_left", globalPropertyi("an-24rv/covers/antiice_left"))  -- left anti-ice detector cover
defineProperty("antiice_right", globalPropertyi("an-24rv/covers/antiice_right"))  -- right anti-ice detector cover
defineProperty("rockets", globalPropertyi("an-24rv/covers/rockets"))  -- rockets cover
defineProperty("pitot_1", globalPropertyi("an-24rv/covers/pitot_1"))  -- pitot 1
defineProperty("pitot_2", globalPropertyi("an-24rv/covers/pitot_2"))  -- pitot 2
defineProperty("pitot_3", globalPropertyi("an-24rv/covers/pitot_3"))  -- pitot 3
defineProperty("grounding", globalPropertyi("an-24rv/covers/grounding"))  -- grounding wire
defineProperty("gear_blocks", globalPropertyi("an-24rv/covers/gear_blocks"))  -- gear blocks

defineProperty("ground_available", globalPropertyi("an-24rv/power/ground_available"))

defineProperty("cabin_hatch", globalPropertyi("an-24rv/lukbesson_switch"))  -- open/close cabin hatch
...
defineProperty("ground_sound", globalPropertyi("an-24rv/sound/gndsound"))
...
defineProperty("cabin_hatch_stat", globalPropertyf("an-24rv/lukbesson"))  -- open/close cabin hatch
