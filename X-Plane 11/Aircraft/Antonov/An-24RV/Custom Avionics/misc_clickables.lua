...
-- datarefs
defineProperty("rv2_sw", globalPropertyi("an-24rv/gauges/rv_2_sw")) -- switch for radioaltimeter
defineProperty("feet_meter_sw", globalPropertyf("an-24rv/gauges/feet_meter_sw")) -- gauge switcher ON/OF
defineProperty("GIK_button", globalPropertyi("an-24rv/gauges/GIK_button")) -- button for sync GIK with mag compass
defineProperty("GIK_sw", globalPropertyi("an-24rv/gauges/GIK_sw")) -- ON/OFF GIK
defineProperty("GPK_sw", globalPropertyi("an-24rv/gauges/GPK_sw")) -- ON/OFF GPK
defineProperty("uvid_30_sw", globalPropertyf("an-24rv/gauges/uvid_30_sw")) -- UVID-30 switcher ON/OF
defineProperty("sq_emerg_cap", globalPropertyi("an-24rv/sq/sq_emerg_cap"))
...
defineProperty("ark_vor", globalPropertyi("an-24rv/gauges/ark_vor")) -- switcher ARK/VOR
defineProperty("weel_switch", globalPropertyi("an-24rv/gauges/noseweel")) -- nosewheel mode
defineProperty("nav_light_sw", globalPropertyi("an-24rv/misc/nav_light_sw")) -- nav lights and beacons switch
defineProperty("lan_light_sw", globalPropertyi("an-24rv/misc/lan_light_sw")) -- landing lights switch
defineProperty("lan_light_open_sw", globalPropertyi("an-24rv/misc/lan_light_open_sw")) -- landing lights switch
defineProperty("cockpit_red", globalPropertyf("an-24rv/misc/cockpit_red")) -- red cockpit light rotary
defineProperty("cockpit_spot1", globalPropertyf("an-24rv/misc/cockpit_spot1")) -- cockpit spotlight rotary
defineProperty("cockpit_spot2", globalPropertyf("an-24rv/misc/cockpit_spot2")) -- cockpit spotlight rotary
defineProperty("cockpit_panel", globalPropertyf("an-24rv/misc/cockpit_panel")) -- cockpit spotlight rotary
defineProperty("wiper_sw", globalPropertyi("sim/cockpit2/switches/wiper_speed"))  -- 0=off,1=25%speed,2=50%speed,3=100%speed.
defineProperty("siren_button", globalPropertyi("an-24rv/gauges/siren_button")) -- button for temporary OFF sirene
