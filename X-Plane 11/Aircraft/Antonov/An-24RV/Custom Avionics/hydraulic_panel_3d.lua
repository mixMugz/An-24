...
defineProperty("hydro_quantity", globalPropertyf("an-24rv/hydro/hydro_quantity")) -- quantity of hydraulic liquid. initially 28 liters. in work downs to 21 liters. also can flow out in come case of failure.
defineProperty("hydro_store", globalPropertyf("an-24rv/hydro/hydro_store")) -- pressure in main hydro storage
defineProperty("hydro_circle", globalPropertyi("an-24rv/hydro/hydro_circle"))  -- connect main and emergency feeds
defineProperty("brake1", globalPropertyf("an-24rv/hydro/brake_left")) -- gear brake ratio. 0 = min, 1 = max
defineProperty("brake2", globalPropertyf("an-24rv/hydro/brake_right")) -- gear brake ratio. 0 = min, 1 = max
defineProperty("block_brake", globalPropertyf("an-24rv/hydro/park_brake"))  -- blocks brakes
defineProperty("brake_press", globalPropertyf("an-24rv/hydro/brake_press"))  -- pressure in braking system
...
defineProperty("gear_valve", globalPropertyi("an-24rv/hydro/gear_valve")) -- position of gear valve for gydraulic calculations and animations.
...
defineProperty("gear_unblock_cap", globalPropertyi("an-24rv/hydro/gear_unblock_cap")) -- remove block from gear retraction on ground
defineProperty("flaps_valve", globalPropertyi("an-24rv/hydro/flaps_valve")) -- position of flaps valve for gydraulic calculations and animations.
defineProperty("flaps_rotary", globalPropertyi("an-24rv/hydro/flaps_rotary")) -- position of flaps valve for gydraulic calculations and animations.
defineProperty("flaps_valve_emerg", globalPropertyi("an-24rv/hydro/flaps_valve_emerg")) -- position of emergency flaps valve for gydraulic calculations and animations.
defineProperty("flaps_valve_emerg_cap", globalPropertyi("an-24rv/hydro/flaps_valve_emerg_cap")) -- position of emergency flaps valve for gydraulic calculations and animations.
defineProperty("emerg_pump_sw", globalPropertyi("an-24rv/hydro/emerg_pump_sw")) -- emergency hydro pump switcher. if its ON and power exist - emergency bus will gain pressure
