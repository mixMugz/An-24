...
defineProperty("auasp_warn", globalPropertyi("an-24rv/gauges/auasp_warning"))  -- warning from AUASP
defineProperty("rv2_cc", globalPropertyf("an-24rv/gauges/rv_2_cc"))  -- rv work
defineProperty("ssos_warning", globalPropertyi("an-24rv/gauges/ssos_warning"))  -- warning from SSOS
