...
--defineProperty("autopilot_statePF", globalPropertyf("an-24rv/autopilot_state_PF"))
--defineProperty("autopilot_stateFO", globalPropertyf("an-24rv/autopilot_state_FO"))
