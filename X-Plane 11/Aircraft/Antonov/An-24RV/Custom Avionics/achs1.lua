...
defineProperty("sec_mode_clock", globalPropertyf("an-24rv/clocks/sec_mode"))  -- sec_mode
defineProperty("flight_mode_clock", globalPropertyf("an-24rv/clocks/flight_mode"))  -- sec_mode
defineProperty("chrono_sec_angle", globalPropertyf("an-24rv/clocks/chrono_sec_angle"))  -- sec_mode
defineProperty("chrono_min_angle", globalPropertyf("an-24rv/clocks/chrono_min_angle"))  -- sec_mode
defineProperty("flight_min_angle", globalPropertyf("an-24rv/clocks/flight_min_angle"))  -- sec_mode
defineProperty("flight_hour_angle", globalPropertyf("an-24rv/clocks/flight_hour_angle"))  -- sec_mode
defineProperty("sec_time", globalPropertyf("an-24rv/clocks/sec_time"))  -- sec_mode
defineProperty("flight_time", globalPropertyf("an-24rv/clocks/flight_time"))  -- sec_mode
defineProperty("start_sec", globalPropertyf("an-24rv/clocks/start_sec"))  -- sec_mode
defineProperty("start_flight", globalPropertyf("an-24rv/clocks/start_flight"))  -- sec_mode
