...
defineProperty("emerg_brake", globalPropertyf("an-24rv/hydro/emerg_brake"))  -- pressure in braking system
defineProperty("steer", globalPropertyf("sim/flightmodel2/gear/tire_steer_actual_deg[0]")) -- front gear steer deg
defineProperty("frontgear_use_hydro", globalPropertyi("an-24rv/hydro/frontgear_use_hydro")) -- front gear steering manipulates by hydraulic system
...
-- power calculations
defineProperty("pump_cc", globalPropertyf("an-24rv/hydro/pump_cc")) -- emergency pump consumption
...
local pump_sound = loadSample('sounds/custom/hydro_pump.wav')
local pump_gain = 0
