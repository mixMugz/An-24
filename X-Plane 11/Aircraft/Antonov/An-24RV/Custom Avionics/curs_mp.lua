...
-- sources
defineProperty("obs1_fromto", globalPropertyi("an-24rv/gauges/obs1_fromto")) -- obs from-to switcher
defineProperty("obs2_fromto", globalPropertyi("an-24rv/gauges/obs2_fromto")) -- obs from-to switcher
defineProperty("sp_ils", globalPropertyi("an-24rv/gauges/sp_ils")) -- switcher between SP-50 and ILS system
defineProperty("nav_select", globalPropertyi("an-24rv/gauges/nav_select")) -- selector between NAV1 and NAV2
defineProperty("mrp_mode", globalPropertyi("an-24rv/gauges/mrp_mode")) -- 0 - landing, 1 = navigation
...
defineProperty("rsbn_deflection", globalPropertyf("an-24rv/rsbn/defl"))
defineProperty("rsbn_flag", globalPropertyi("an-24rv/rsbn/flag"))
...
defineProperty("curs_mp1_sw", globalPropertyi("an-24rv/gauges/curs_mp1_sw")) 
defineProperty("curs_mp2_sw", globalPropertyi("an-24rv/gauges/curs_mp2_sw")) 
defineProperty("curs_mp_cc", globalPropertyf("an-24rv/gauges/curs_mp_cc")) 


-- result
defineProperty("k1_flag", globalPropertyi("an-24rv/gauges/k1_flag")) -- flag for course on left kppm
defineProperty("k2_flag", globalPropertyi("an-24rv/gauges/k2_flag")) -- flag for course on right kppm
defineProperty("g1_flag", globalPropertyi("an-24rv/gauges/g1_flag")) -- flag for glide on left kppm
defineProperty("g2_flag", globalPropertyi("an-24rv/gauges/g2_flag")) -- flag for glide on right kppm
defineProperty("curs_1", globalPropertyf("an-24rv/gauges/curs_1")) -- KursMP course for left kppm
defineProperty("curs_2", globalPropertyf("an-24rv/gauges/curs_2")) -- KursMP course for right kppm
defineProperty("glide_1", globalPropertyf("an-24rv/gauges/glide_1")) -- KursMP glide for left kppm
defineProperty("glide_2", globalPropertyf("an-24rv/gauges/glide_2")) -- KursMP glide for right kppm

defineProperty("vor_1", globalPropertyf("an-24rv/gauges/vor_1")) -- KursMP course for left kppm
defineProperty("vor_2", globalPropertyf("an-24rv/gauges/vor_2")) -- KursMP course for right kppm

defineProperty("obs1_fromto_lit", globalPropertyi("an-24rv/gauges/obs1_fromto_lit")) -- Nav-To-From indication, nav1, pilot, 0 is flag, 1 is to, 2 is from.
defineProperty("obs2_fromto_lit", globalPropertyi("an-24rv/gauges/obs2_fromto_lit")) -- Nav-To-From indication, nav1, pilot, 0 is flag, 1 is to, 2 is from.
