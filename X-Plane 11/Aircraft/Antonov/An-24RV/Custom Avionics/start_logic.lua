...
defineProperty("ru19_N1", globalPropertyf("an-24rv/start/ru19_N1"))  
...
-- custom datarefs
defineProperty("fuel_start1", globalPropertyi("an-24rv/start/fuel_start1")) -- fuel valves
defineProperty("fuel_start2", globalPropertyi("an-24rv/start/fuel_start2")) -- fuel valves
defineProperty("fuel_start3", globalPropertyi("an-24rv/start/fuel_start3")) -- fuel valves

defineProperty("stg1_starter", globalPropertyi("an-24rv/power/stg1_starter"))  -- generator worknig as starter
defineProperty("stg2_starter", globalPropertyi("an-24rv/power/stg2_starter")) 
defineProperty("gs24_starter", globalPropertyi("an-24rv/power/gs24_starter")) 

defineProperty("eng_start_btn", globalPropertyi("an-24rv/start/eng_start_btn")) -- start selected engine
defineProperty("start_at_ground_cap", globalPropertyi("an-24rv/start/start_at_ground_cap")) -- select start mode cap
defineProperty("start_at_ground", globalPropertyi("an-24rv/start/start_at_ground")) -- select start mode
defineProperty("sel_left_right", globalPropertyi("an-24rv/start/sel_left_right")) -- select engine to start. -1 - left, 0 - none, +1 - right
defineProperty("eng_start_mode", globalPropertyi("an-24rv/start/eng_start_mode")) -- select start mode. start or fail start
defineProperty("eng_start_stop", globalPropertyi("an-24rv/start/eng_start_stop")) -- button for stop start process
defineProperty("left_temp_check", globalPropertyi("an-24rv/start/left_temp_check")) -- select temp check mode
defineProperty("left_prt24_on", globalPropertyi("an-24rv/start/left_prt24_on")) -- PRT24 on
defineProperty("right_temp_check", globalPropertyi("an-24rv/start/right_temp_check")) -- select temp check mode
defineProperty("right_prt24_on", globalPropertyi("an-24rv/start/right_prt24_on")) -- PRT24 on

defineProperty("ru19_air_start_btn", globalPropertyi("an-24rv/start/ru19_air_start_btn")) -- start at flight button
defineProperty("ru19_ground_start_btn", globalPropertyi("an-24rv/start/ru19_ground_start_btn")) -- start on ground button
defineProperty("ru19_ground_start_cap", globalPropertyi("an-24rv/start/ru19_ground_start_btn")) -- start on ground button cap
defineProperty("ru19_start_mode", globalPropertyi("an-24rv/start/ru19_start_mode")) -- select start mode. start or fail start
defineProperty("ru19_start_stop", globalPropertyi("an-24rv/start/ru19_start_stop")) -- stop button for ru19

defineProperty("ru19_start_main_sw", globalPropertyi("an-24rv/start/ru19_start_main_sw")) --   -- main switcher for ru19
defineProperty("ru19_start_main_sw_cap", globalPropertyi("an-24rv/start/ru19_start_main_sw_cap")) -- main switcher for ru19
...
defineProperty("virt_rud1", globalPropertyf("an-24rv/misc/virt_rud1"))
defineProperty("virt_rud2", globalPropertyf("an-24rv/misc/virt_rud2"))
defineProperty("virt_rud3", globalPropertyf("an-24rv/misc/virt_rud3"))

defineProperty("apd_work_lit", globalPropertyi("an-24rv/start/apd_work_lit")) -- lamp for apd
defineProperty("pt29_work_lit", globalPropertyi("an-24rv/start/pt29_work_lit")) -- lamp for ru19 starter
defineProperty("strip_lit", globalPropertyi("an-24rv/start/strip_lit")) -- lamp for ru19 starter

defineProperty("starter_volt", globalPropertyf("an-24rv/start/starter_volt")) -- starter voltage for engines start
defineProperty("starter_amp", globalPropertyf("an-24rv/start/starter_amp")) -- starter amperage for engines start

defineProperty("set_real_startup", globalPropertyi("an-24rv/set/real_startup")) -- when start the engines a lot of thing must to be done
...
local ru19_air_start_btn_command = createCommand("An-24RV/Start/ru19_air_start_btn", "RU19 Air Start button")
function ru19_air_start_btn_handler(phase)  -- for all commands phase equals: 0 on press; 1 while holding; 2 on release
  if phase ~= 2 then
    set(ru19_air_start_btn,1)
  else
    set(ru19_air_start_btn,0)
  end
  return 0
end
registerCommandHandler(ru19_air_start_btn_command, 0, ru19_air_start_btn_handler)

local ru19_ground_start_btn_command = createCommand("An-24RV/Start/ru19_ground_start_btn", "RU19 Ground Start button")
function ru19_ground_start_btn_handler(phase)  -- for all commands phase equals: 0 on press; 1 while holding; 2 on release
  if phase ~= 2 then
...
registerCommandHandler(ru19_ground_start_btn_command, 0, ru19_ground_start_btn_handler)
...
----------------------Tunning startup extended throttle for right engine here---
	...
	local start_button = get(ru19_ground_start_btn) == 1
