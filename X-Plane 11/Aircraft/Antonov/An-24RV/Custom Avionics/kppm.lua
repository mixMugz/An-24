...
-- source
defineProperty("gyro_curse", globalPropertyf("an-24rv/gauges/GIK_curse"))  -- gyro curse from GIK
...
defineProperty("hor_def", globalPropertyf("an-24rv/gauges/curs_1"))
defineProperty("vert_def", globalPropertyf("an-24rv/gauges/glide_1"))
defineProperty("curs_flag", globalPropertyf("an-24rv/gauges/k1_flag"))
defineProperty("glide_flag", globalPropertyf("an-24rv/gauges/g1_flag"))
defineProperty("SC_master", globalPropertyi("scp/api/ismaster")) -- status of SmartCopilot
defineProperty("scale_angle1_smartcopilot", globalPropertyf("an-24rv/gauges/scale_angle_1_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("scale_angle2_smartcopilot", globalPropertyf("an-24rv/gauges/scale_angle_2_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("rotate_dir1_smartcopilot", globalPropertyi("an-24rv/gauges/rotate_dir1_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("rotate_dir2_smartcopilot", globalPropertyi("an-24rv/gauges/rotate_dir2_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("sc_curse_angle", globalPropertyf("an-24rv/gauges/sc_KPPM_1_curse_angle")) -- dataref for SmartCopilot synchronisation
...
local rotate_dir1_left_command = createCommand("An-24RV/Flight/dir1_knob_rotate_left", "Dir Pilot Left Rotate")
...
local rotate_dir1_right_command = createCommand("An-24RV/Flight/dir1_knob_rotate_right", "Dir Pilot Right Rotate")
...
local rotate_dir2_left_command = createCommand("An-24RV/Flight/dir2_knob_rotate_left", "Dir Copilot Left Rotate")
...
local rotate_dir2_right_command = createCommand("An-24RV/Flight/dir2_knob_rotate_right", "Dir Copilot Right Rotate")
