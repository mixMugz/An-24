...
defineProperty("ikm_L", globalPropertyf("an-24rv/gauges/torque_left")) -- torque left
defineProperty("ikm_R", globalPropertyf("an-24rv/gauges/torque_left")) -- torque right
defineProperty("throttle1", globalPropertyf("an-24rv/misc/virt_rud1"))   
defineProperty("throttle2", globalPropertyf("an-24rv/misc/virt_rud2"))
defineProperty("roll", globalPropertyf("an-24rv/ap/indicated_roll")) -- roll for autopilot
defineProperty("pitch", globalPropertyf("an-24rv/ap/indicated_pitch")) -- pitch for autopilot
...
defineProperty("skv_siren", globalPropertyi("an-24rv/skv/skv_siren")) -- depressurisation
...
defineProperty("ap_on", globalPropertyi("an-24rv/ap/ap_on_lit"))  -- AP engaged light
defineProperty("high_vibro", globalPropertyi("an-24rv/gauges/high_vibro"))  -- high vibration
...
defineProperty("gear_down", globalPropertyi("an-24rv/gauges/gear_down")) -- all gears down
defineProperty("roll_high", globalPropertyf("an-24rv/gauges/roll_high")) -- to much roll
defineProperty("SSOS_alarm", globalPropertyi("an-24rv/gauges/SSOS_alarm"))  -- alarm for MSRP
