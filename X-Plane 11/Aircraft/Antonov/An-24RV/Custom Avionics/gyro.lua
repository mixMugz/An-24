...
-- power
defineProperty("bus_DC_27_volt", globalPropertyf("an-24rv/power/bus_DC_27_volt_emerg")) -- power 27 volt
defineProperty("bus_AC_36_volt", globalPropertyf("an-24rv/power/bus_AC_36_volt")) -- power 36 volt
defineProperty("switch", globalPropertyf("an-24rv/gauges/GIK_sw"))  -- switcher to turn ON/OFF
defineProperty("gyro_cc", globalPropertyf("an-24rv/gauges/GIK_cc"))  -- current consumtion

-- fail
defineProperty("fail", globalPropertyf("sim/operation/failures/rel_ss_dgy"))

-- result
defineProperty("gyro_curse", globalPropertyf("an-24rv/gauges/gyro_curse"))
