...
defineProperty("nav_light", globalPropertyf("an-24rv/misc/nav_light")) -- nav light can shine
defineProperty("beacon_light", globalPropertyf("an-24rv/misc/beacon_light")) -- beacon light ratio
defineProperty("azs_beacon_down", globalPropertyf("an-24rv/beacon_down"))
defineProperty("azs_beacon_up", globalPropertyf("an-24rv/beacon_up"))
...
defineProperty("cockpit_light_cc", globalPropertyf("an-24rv/misc/cockpit_light_cc")) -- light current consumption
