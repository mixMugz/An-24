...
-- source
defineProperty("gyro", globalPropertyf("an-24rv/gauges/gyro2_curse")) -- source gyro
...
defineProperty("sc_curse_angle", globalPropertyf("an-24rv/gauges/sc_curse_angle")) -- SmartCopilot
defineProperty("sc_ap_curse_angle", globalPropertyf("an-24rv/gauges/sc_ap_curse_angle")) -- SmartCopilot

-- result
defineProperty("GPK_curse", globalPropertyf("an-24rv/gauges/GPK_curse"))  -- gyro curse from GPK
defineProperty("ap_GPK_curse", globalPropertyf("an-24rv/ap/curse_gpk"))  -- gyro curse from GPK for autopilot
-- images
