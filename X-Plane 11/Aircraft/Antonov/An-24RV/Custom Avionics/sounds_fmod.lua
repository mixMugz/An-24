...
defineProperty("int_cutoff", globalPropertyf("an-24rv/sound/interier_cutoff"))  -- cutoff detector
...
defineProperty("cabin_hatch", globalPropertyf("an-24rv/lukbesson"))  -- open/close cabin hatch
...
function update()
  ...
  if get(emerg1) < 0.5 and get(emerg2) < 0.5 and get(cargo1) < 0.5 and get(cargo2) < 0.5 and get(paxdoor) < 0.5 and get(cabin_hatch) < 1 then
  ...
  elseif get(cabin_hatch) > 0.5 then
