...
-- source
defineProperty("tro_all", globalPropertyf("sim/cockpit2/engine/actuators/throttle_ratio_all"))
...
defineProperty("rud_close", globalPropertyi("an-24rv/misc/rud_close"))
defineProperty("rud_close_ru19", globalPropertyi("an-24rv/misc/rud_close_ru19"))
defineProperty("rud_close_pos", globalPropertyi("an-24rv/misc/rud_close_pos"))
defineProperty("switch_rud", globalPropertyi("an-24rv/set/switch_rud")) -- switch or hold rud stopors
defineProperty("switch_rud19", globalPropertyi("an-24rv/set/switch_rud19")) -- switch or hold rud stopors
defineProperty("frame_time", globalPropertyf("an-24rv/time/frame_time")) -- time for frames

function onPlaneLoaded()
 print("*** HOHOHOHO! overrides: ",get(override))
end
print("*** overrides: ",get(override))
set(override, 1) -- use it for take control via plugin
set(tro_need_1, 0.2)
set(tro_need_2, 0.2)
set(tro_need_3, 0.2)
print("*** SET overrides: ",get(override))
