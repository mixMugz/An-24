...
defineProperty("real_brakes", globalPropertyi("an-24rv/set/real_brakes")) -- brakes can overheat and fail
...
defineProperty("abs_sw", globalPropertyi("an-24rv/hydro/abs_sw"))  -- abs switcher
