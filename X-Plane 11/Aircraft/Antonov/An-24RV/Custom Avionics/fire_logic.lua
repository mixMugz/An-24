...
defineProperty("fire_main_switcher", globalPropertyi("an-24rv/fire/fire_main_switcher"))  -- main switcher for fire system.
defineProperty("fire_left_wing_btn", globalPropertyi("an-24rv/fire/fire_left_wing_btn"))  -- fire in left wing button
defineProperty("fire_left_wing_lit", globalPropertyi("an-24rv/fire/fire_left_wing_lit"))  -- fire in left wing light
defineProperty("fire_right_wing_btn", globalPropertyi("an-24rv/fire/fire_right_wing_btn"))  -- fire in right wing button
defineProperty("fire_right_wing_lit", globalPropertyi("an-24rv/fire/fire_right_wing_lit"))  -- fire in right wing light
defineProperty("fire_left_nacelle_btn", globalPropertyi("an-24rv/fire/fire_left_nacelle_btn"))  -- fire in left nacelle button
defineProperty("fire_left_nacelle_lit", globalPropertyi("an-24rv/fire/fire_left_nacelle_lit"))  -- fire in left nacelle light
defineProperty("fire_right_nacelle_btn", globalPropertyi("an-24rv/fire/fire_right_nacelle_btn"))  -- fire in right nacelle button
defineProperty("fire_right_nacelle_lit", globalPropertyi("an-24rv/fire/fire_right_nacelle_lit"))  -- fire in right nacelle light
defineProperty("fire_ru19_btn", globalPropertyi("an-24rv/fire/fire_ru19_btn"))  -- fire in ru19 button
defineProperty("fire_ru19_lit", globalPropertyi("an-24rv/fire/fire_ru19_lit"))  -- fire in ru19 light

-- engines lamps and buttons
defineProperty("fire_left_eng_lit", globalPropertyi("an-24rv/fire/fire_left_eng_lit"))  -- fire in left engine light
defineProperty("fire_right_eng_lit", globalPropertyi("an-24rv/fire/fire_right_eng_lit"))  -- fire in right engine light

defineProperty("ext_left_ready_lit", globalPropertyi("an-24rv/fire/ext_left_ready_lit"))  -- left engine extinguisher ready
defineProperty("ext_right_ready_lit", globalPropertyi("an-24rv/fire/ext_right_ready_lit"))  -- right engine extinguisher ready
defineProperty("ext_first_ready_lit", globalPropertyi("an-24rv/fire/ext_first_ready_lit"))  -- furst turn extinguisher ready
defineProperty("ext_second_ready_lit", globalPropertyi("an-24rv/fire/ext_second_ready_lit"))  -- second turn extinguisher ready

defineProperty("fire_left_eng_ext", globalPropertyi("an-24rv/fire/fire_left_eng_ext"))  -- button for left engine fire extinguisher
defineProperty("fire_left_eng_ext_cap", globalPropertyi("an-24rv/fire/fire_left_eng_ext_cap"))  -- cap for button for left engine fire extinguisher

defineProperty("fire_right_eng_ext", globalPropertyi("an-24rv/fire/fire_right_eng_ext"))  -- button for right engine fire extinguisher
defineProperty("fire_right_eng_ext_cap", globalPropertyi("an-24rv/fire/fire_right_eng_ext_cap"))  -- cap for button for right engine fire extinguisher

defineProperty("fire_second_ext", globalPropertyi("an-24rv/fire/fire_second_ext"))  -- button for second turn fire extinguisher
defineProperty("fire_second_ext_cap", globalPropertyi("an-24rv/fire/fire_second_ext_cap"))  -- cap for button for second turn fire extinguisher
...
defineProperty("fire_warinig", globalPropertyi("an-24rv/fire/fire_warinig")) -- fire warning for sirene logic

-- power
defineProperty("bus_DC_27_volt", globalPropertyf("an-24rv/power/bus_DC_27_volt_emerg")) 
defineProperty("fire_cc", globalPropertyf("an-24rv/fire/fire_cc")) 

--an-24rv/fire/fire_warinig
-- time
...
-- reality
defineProperty("set_real_fire", globalPropertyi("an-24rv/set/real_fire")) -- fire will affect wings and nearest mech
