...
-- custom switchers
defineProperty("pitot_1_sw", globalPropertyi("an-24rv/ice/pitot1_sw"))   -- pitot heat 1
defineProperty("pitot_2_sw", globalPropertyi("an-24rv/ice/pitot2_sw"))   -- pitot heat 2
defineProperty("prop_ht_sw", globalPropertyi("an-24rv/ice/prop_ht_sw"))   -- propeller heat
defineProperty("wind_ht_psw1", globalPropertyi("an-24rv/ice/window_ht_psw1"))   -- window heat pilot sw1 (low)
defineProperty("wind_ht_psw2", globalPropertyi("an-24rv/ice/window_ht_psw2"))   -- window heat pilot sw2 (high)
defineProperty("wind_ht_cpsw1", globalPropertyi("an-24rv/ice/window_ht_cpsw1"))   -- window heat copilot sw1 (low)
defineProperty("wind_ht_cpsw2", globalPropertyi("an-24rv/ice/window_ht_cpsw2"))   -- window heat copilot sw2 (high)
defineProperty("wing_ht_sw", globalPropertyi("an-24rv/ice/wing_ht_sw"))  -- on/off wing heat
defineProperty("engine_ht_sw", globalPropertyi("an-24rv/ice/engine_ht_sw"))  -- on/off engine heat
defineProperty("ice_detect_sw", globalPropertyi("an-24rv/ice/rio_sw"))  -- on/off ice detection
defineProperty("aoa_ht_sw", globalPropertyi("an-24rv/ice/aoa_ht_sw"))  -- on/off AOA heat
...
defineProperty("prop_left_lit_2d", globalPropertyi("an-24rv/ice/prop_left_lit"))  -- for 2D panel
defineProperty("prop_right_lit_2d", globalPropertyi("an-24rv/ice/prop_right_lit"))  -- for 2D panel
...
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_low_pilot_on", "Window heat low pilot on."), 0, function(p) if p == 0 and get(wind_ht_psw1) ~= 1 then set(wind_ht_psw1, 1) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_low_pilot_off", "Window heat low pilot off."), 0, function(p) if p == 0 and get(wind_ht_psw1) ~= 0 then set(wind_ht_psw1, 0) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_low_pilot_toggle", "Window heat low pilot toggle."), 0, function(p) if p == 0 then if get(wind_ht_psw1) ~= 1 then set(wind_ht_psw1, 1) else set(wind_ht_psw1, 0) end end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_high_pilot_on", "Window heat high pilot on."), 0, function(p) if p == 0 and get(wind_ht_psw2) ~= 1 then set(wind_ht_psw2, 1) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_high_pilot_off", "Window heat high pilot off."), 0, function(p) if p == 0 and get(wind_ht_psw2) ~= 0 then set(wind_ht_psw2, 0) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Pilot/window_heat_high_pilot_toggle", "Window heat high pilot toggle."), 0, function(p) if p == 0 then if get(wind_ht_psw2) ~= 1 then set(wind_ht_psw2, 1) else set(wind_ht_psw2, 0) end end return 0 end)

registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_low_copilot_on", "Window heat low copilot on."), 0, function(p) if p == 0 and get(wind_ht_cpsw1) ~= 1 then set(wind_ht_cpsw1, 1) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_low_copilot_off", "Window heat low copilot off."), 0, function(p) if p == 0 and get(wind_ht_cpsw1) ~= 0 then set(wind_ht_cpsw1, 0) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_low_copilot_toggle", "Window heat low copilot toggle."), 0, function(p) if p == 0 then if get(wind_ht_cpsw1) ~= 1 then set(wind_ht_cpsw1, 1) else set(wind_ht_cpsw1, 0) end end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_high_copilot_on", "Window heat high copilot on."), 0, function(p) if p == 0 and get(wind_ht_cpsw2) ~= 1 then set(wind_ht_cpsw2, 1) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_high_copilot_off", "Window heat high copilot off."), 0, function(p) if p == 0 and get(wind_ht_cpsw2) ~= 0 then set(wind_ht_cpsw2, 0) end return 0 end)
registerCommandHandler(createCommand("An-24RV/Instruments/Copilot/window_heat_high_copilot_toggle", "Window heat high copilot toggle."), 0, function(p) if p == 0 then if get(wind_ht_cpsw2) ~= 1 then set(wind_ht_cpsw2, 1) else set(wind_ht_cpsw2, 0) end end return 0 end)
