...
defineProperty("wind_ht_sw1", globalPropertyi("an-24rv/ice/window_ht_sw1"))   -- window heat
defineProperty("wind_ht_sw2", globalPropertyi("an-24rv/ice/window_ht_sw2"))   -- window heat
...
if  passed > 0 then
	...
	if power115 then
		...
		if get(wind_ht_sw1) == 1 and get(wind_ht_sw2) == 1 then -- window heat
			set(wind_ht, 1)
