...
defineProperty("wind_ht_sw2", globalPropertyi("an-24rv/ice/window_ht_sw2"))   -- window heat copilot
...
-- GPK panel
defineProperty("lat", globalPropertyf("an-24rv/gauges/GPK_lat")) -- latitude position on panel
defineProperty("lat_angle", globalPropertyf("an-24rv/gauges/GPK_lat_rotary")) -- angle for lat rotary
defineProperty("corr_switcher", globalPropertyi("an-24rv/gauges/GPK_corr_sw")) -- correction switcher ON/OFF
defineProperty("corr_rot", globalPropertyi("an-24rv/gauges/GPK_corr_rot")) -- correction rotary

-- skv
defineProperty("bleed1_sw", globalPropertyi("an-24rv/skv/bleed1_sw")) 
defineProperty("bleed2_sw", globalPropertyi("an-24rv/skv/bleed2_sw")) 
