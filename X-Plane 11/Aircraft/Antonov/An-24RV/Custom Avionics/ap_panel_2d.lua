...
defineProperty("ap_pitch", globalPropertyi("an-24rv/ap/ap_pitch"))  -- pitch control
...
defineProperty("gear_valve", globalPropertyi("an-24rv/hydro/gear_valve")) -- position of gear valve for gydraulic calculations and animations maximum 160.
