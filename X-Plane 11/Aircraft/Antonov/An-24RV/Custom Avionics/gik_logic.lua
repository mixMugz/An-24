...
defineProperty("GIK_sw", globalPropertyi("an-24rv/gauges/GIK_sw")) 

-- control
defineProperty("GIK_button", globalPropertyi("an-24rv/gauges/GIK_button")) 
defineProperty("GIK_curse", globalPropertyf("an-24rv/gauges/GIK_curse"))
defineProperty("ap_GIK_curse", globalPropertyf("an-24rv/ap/curse_gik"))

-- sources
defineProperty("gyro", globalPropertyf("an-24rv/gauges/gyro_curse"))
...
defineProperty("sc_angle", globalPropertyf("an-24rv/gauges/sc_angle")) -- SmartCopilot
defineProperty("sc_ap_angle", globalPropertyf("an-24rv/gauges/sc_ap_angle")) -- SmartCopilot
