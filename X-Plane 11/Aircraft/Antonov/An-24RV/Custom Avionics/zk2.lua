...
defineProperty("zk_scale_angle_smartcopilot", globalPropertyf("an-24rv/gauges/zk_scale_angle_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("zk_rotate_dir_smartcopilot", globalPropertyi("an-24rv/gauges/zk_rotate_dir_smartcopilot")) -- dataref for SmartCopilot synchronisation
defineProperty("sc_curse_angle", globalPropertyf("an-24rv/gauges/sc_ZK_curse_angle")) -- dataref for SmartCopilot synchronisation
