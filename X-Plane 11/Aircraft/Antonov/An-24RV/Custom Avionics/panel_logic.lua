-- panel switchers
defineProperty("main_menu_subpanel", globalPropertyi("an-24rv/panels/main_menu_subpanel"))
defineProperty("menu_logo", globalPropertyi("an-24rv/panels/menu_logo"))
defineProperty("nav1_subpanel", globalPropertyi("an-24rv/panels/nav1_subpanel"))
defineProperty("nav2_subpanel", globalPropertyi("an-24rv/panels/nav2_subpanel"))
...
defineProperty("ap_panel_subpanel", globalPropertyi("an-24rv/panels/ap_panel_subpanel"))
defineProperty("right_subpanel", globalPropertyi("an-24rv/panels/right_subpanel"))
defineProperty("nl10m_subpanel", globalPropertyi("an-24rv/panels/nl10m_subpanel"))
defineProperty("radio_subpanel", globalPropertyi("an-24rv/panels/radio_subpanel"))
defineProperty("service_subpanel", globalPropertyi("an-24rv/panels/service_subpanel"))
defineProperty("payload_subpanel", globalPropertyi("an-24rv/panels/payload_subpanel"))
defineProperty("options_subpanel", globalPropertyi("an-24rv/panels/options_subpanel"))
defineProperty("fuel_subpanel", globalPropertyi("an-24rv/panels/fuel_subpanel"))
defineProperty("map_subpanel", globalPropertyi("an-24rv/panels/map_subpanel"))
defineProperty("info_subpanel", globalPropertyi("an-24rv/panels/info_subpanel"))
defineProperty("camera_subpanel", globalPropertyi("an-24rv/panels/camera_subpanel"))
defineProperty("rsbn_subpanel", globalPropertyi("an-24rv/panels/rsbn_subpanel"))
defineProperty("nas1_subpanel", globalPropertyi("an-24rv/panels/nas1_subpanel"))
defineProperty("uphone_subpanel", globalPropertyi("an-24rv/panels/uphone_subpanel"))
defineProperty("fplan_subpanel", globalPropertyi("an-24rv/panels/fplan_subpanel"))
...
local main_menu_subpanel_command = createCommand("An-24RV/Panels/panel_1", "Main menu")
...
local nav1_subpanel_command = createCommand("An-24RV/Panels/panel_2", "Navigation #1 panel")
...
local nav2_subpanel_command = createCommand("An-24RV/Panels/panel_3", "Navigation #2 panel")
...
local electropanel_subpanel_command = createCommand("An-24RV/Panels/panel_4", "Electric panel")
...
local fuel_subpanel_command = createCommand("An-24RV/Panels/panel_5", "Fuel panel")
...
local left_subpanel_command = createCommand("An-24RV/Panels/panel_6", "Laft (pilot) panel")
...
local right_subpanel_command = createCommand("An-24RV/Panels/panel_7", "Right (Copilot) panel")
...
local ap_panel_subpanel_command = createCommand("An-24RV/Panels/panel_8", "Autopilot panel")
...
local radio_subpanel_command = createCommand("An-24RV/Panels/panel_9", "Radio panel")
...
local service_subpanel_command = createCommand("An-24RV/Panels/panel_10", "Service panel")
...
local payload_subpanel_command = createCommand("An-24RV/Panels/panel_11", "Payload panel")
...
local nl10m_subpanel_command = createCommand("An-24RV/Panels/panel_12", "NL10m panel")
...
local map_subpanel_command = createCommand("An-24RV/Panels/panel_13", "Map panel")
...
local options_subpanel_command = createCommand("An-24RV/Panels/panel_14", "Options panel")
...
local info_subpanel_command = createCommand("An-24RV/Panels/panel_15", "Info panel")
...
local camera_subpanel_command = createCommand("An-24RV/Panels/panel_16", "Camera panel")
