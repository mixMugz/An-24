...
defineProperty("indicated_roll", globalPropertyf("an-24rv/ap/indicated_roll"))  -- roll from AHZ
defineProperty("indicated_pitch", globalPropertyf("an-24rv/ap/indicated_pitch"))  -- pitch from AHZ
defineProperty("curse_gik", globalPropertyf("an-24rv/ap/curse_gik"))  -- curse diff from GIK gauge
defineProperty("curse_gpk", globalPropertyf("an-24rv/ap/curse_gpk"))  -- curse diff from GPK gauge
defineProperty("curse_zk", globalPropertyf("an-24rv/ap/curse_zk"))  -- curse diff from ZK2 gauge
...
defineProperty("pitch_force", globalPropertyf("an-24rv/ap/ap_pitch_comm"))
...
-- switchers
defineProperty("ap_power", globalPropertyi("an-24rv/ap/ap_power"))  -- power of AP
defineProperty("ap_trim", globalPropertyi("an-24rv/ap/ap_trim"))  -- use trimmer of AP
defineProperty("ap_ON", globalPropertyi("an-24rv/ap/ap_ON"))  -- main button for engage AP
defineProperty("ap_kv", globalPropertyi("an-24rv/ap/ap_kv"))  -- button for altitude hold
defineProperty("ap_horizont", globalPropertyi("an-24rv/ap/ap_horizont"))  -- button to set horizontal position of plane
defineProperty("ap_curse_stab", globalPropertyi("an-24rv/ap/ap_curse_stab"))  -- switcher for curse stab. turn/GPK/GIK
defineProperty("ap_pitch", globalPropertyi("an-24rv/ap/ap_pitch"))  -- pitch control UP and DOWN
defineProperty("ap_pitch_sw", globalPropertyi("an-24rv/ap/ap_pitch_sw"))  -- engage pitch control
defineProperty("ap_roll", globalPropertyf("an-24rv/ap/ap_roll"))   -- roll knob
-- lights
defineProperty("ap_ready_lit", globalPropertyi("an-24rv/ap/ap_ready_lit"))  -- ready light
defineProperty("ap_on_lit", globalPropertyi("an-24rv/ap/ap_on_lit"))  -- AP engaged light
defineProperty("ap_kv_lit", globalPropertyi("an-24rv/ap/ap_kv_lit"))  -- alt stab engaged
defineProperty("ap_up_lit", globalPropertyi("an-24rv/ap/ap_up_lit"))  -- AP feels UP force on stab
defineProperty("ap_down_lit", globalPropertyi("an-24rv/ap/ap_down_lit"))  -- AP feels DOWN force on stab
defineProperty("ap_ail_fail_lit", globalPropertyi("an-24rv/ap/ap_ail_fail_lit"))  -- aileron trim failed lamp
defineProperty("ap_elev_fail_lit", globalPropertyi("an-24rv/ap/ap_elev_fail_lit"))  -- elevator trim failed lamp

-- controls
defineProperty("ap_roll_diff", globalPropertyf("an-24rv/ap/ap_roll_diff"))  -- difference between needed and current roll (bank)
defineProperty("ap_pitch_diff", globalPropertyf("an-24rv/ap/ap_pitch_diff"))  -- difference between needed and current pitch
defineProperty("ap_hdg_diff", globalPropertyf("an-24rv/ap/ap_hdg_diff"))  -- difference between needed and current heading
defineProperty("ap_roll_power", globalPropertyi("an-24rv/ap/ap_roll_power"))  -- power for aileron mechanic
defineProperty("ap_pitch_power", globalPropertyi("an-24rv/ap/ap_pitch_power"))  -- power for elevator mechanic
defineProperty("ap_hdg_power", globalPropertyi("an-24rv/ap/ap_hdg_power"))  -- power for rudder mechanic
defineProperty("yaw_spd", globalPropertyf("an-24rv/ap/ap_yaw_spd")) -- current yaw speed deg/sec
