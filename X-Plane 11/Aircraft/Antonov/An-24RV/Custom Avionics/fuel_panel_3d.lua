...
--defineProperty("mixt_valve1", globalPropertyf("an-24rv/fuel/fuel_access1")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
--defineProperty("mixt_valve2", globalPropertyf("an-24rv/fuel/fuel_access2")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
--defineProperty("mixt_valve3", globalPropertyf("an-24rv/fuel/fuel_access3")) -- Mixture Control (per engine), 0 = cutoff, 1 = full rich
...
-- defineProperty("sc_fuel_show_left", globalPropertyf("an-24rv/fuel/sc_fuel_show_left")) -- SmartCopilot
-- defineProperty("sc_fuel_show_right", globalPropertyf("an-24rv/fuel/sc_fuel_show_right")) -- SmartCopilot
