...
createProp("an-24rv/controls/yoke_pitch", "float", 0);  -- commanded pitch. -1 = down, +1 = up
createProp("an-24rv/controls/yoke_roll", "float", 0);  -- commanded roll. -1 = left, +1 = right
createProp("an-24rv/controls/yoke_yaw", "float", 0);  -- commanded yaw. -1 = left, +1 = right

defineProperty("yoke_pitch", globalPropertyf("an-24rv/controls/yoke_pitch"))
defineProperty("yoke_roll", globalPropertyf("an-24rv/controls/yoke_roll"))
defineProperty("yoke_yaw", globalPropertyf("an-24rv/controls/yoke_yaw"))
defineProperty("hide_yokes", globalPropertyi("an-24rv/misc/hide_yokes")) -- show/hide yokes
