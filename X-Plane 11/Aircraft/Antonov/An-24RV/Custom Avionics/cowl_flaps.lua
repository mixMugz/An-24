...
defineProperty("flap1_sw", globalPropertyf("an-24rv/cowl/flap_switch_L"))  -- cowl flap manipulator switch
defineProperty("flap2_sw", globalPropertyf("an-24rv/cowl/flap_switch_R")) -- cowl flap manipulator switch
...
defineProperty("oil_t_1", globalPropertyf("an-24rv/engines/oil_temp_left"))
defineProperty("oil_t_2", globalPropertyf("an-24rv/engines/oil_temp_right"))
