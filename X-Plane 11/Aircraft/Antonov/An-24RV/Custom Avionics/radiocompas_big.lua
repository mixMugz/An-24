...
createGlobalPropertyf("an-24rv/misc/ushdb_1_scale_angle", 0) -- поворот шкалы на УШДБ
createGlobalPropertyf("an-24rv/misc/ushdb_1_scale_dir", 0) -- направление поворота шкалы на УШДБ
