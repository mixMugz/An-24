...
defineProperty("stg1_is_gen", globalPropertyi("an-24rv/power/stg1_is_gen"))  -- generator can work as starter for his engine, if this variable = 0.
defineProperty("stg2_is_gen", globalPropertyi("an-24rv/power/stg2_is_gen")) 
defineProperty("gs24_is_gen", globalPropertyi("an-24rv/power/gs24_is_gen")) 
