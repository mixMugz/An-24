...
-- results
createProp("an-24rv/engines/oil_temp_left", "float", 0);  -- oil temperature
createProp("an-24rv/engines/oil_temp_right", "float", 0);  -- oil temperature

defineProperty("oil_temp_left", globalPropertyf("an-24rv/engines/oil_temp_left"))
defineProperty("oil_temp_right", globalPropertyf("an-24rv/engines/oil_temp_right"))
