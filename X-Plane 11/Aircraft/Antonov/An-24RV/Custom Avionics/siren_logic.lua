defineProperty("siren_flaps", globalPropertyi("an-24rv/gauges/flaps_siren"))
defineProperty("siren_auasp", globalPropertyi("an-24rv/gauges/auasp_warning"))
defineProperty("siren_ssos", globalPropertyi("an-24rv/gauges/ssos_warning"))
defineProperty("siren_fire", globalPropertyi("an-24rv/fire/fire_warinig"))
defineProperty("siren_gears", globalPropertyi("an-24rv/gauges/gear_siren"))
defineProperty("skv_siren", globalPropertyi("an-24rv/skv/skv_siren")) 
defineProperty("skv_siren_alarm", globalPropertyi("an-24rv/skv/skv_siren_alarm")) 

defineProperty("siren_armed", globalPropertyf("sim/cockpit/weapons/guns_armed"))
defineProperty("frame_time", globalPropertyf("an-24rv/time/frame_time")) -- time between frames
...
local siren_sound = loadSample('sounds/custom/siren.wav')
