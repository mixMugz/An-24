...
defineProperty("ark_need_freq", globalPropertyi("an-24rv/ark/ark1_need_freq"))

defineProperty("ark_band_need", globalPropertyi("an-24rv/ark/ark1_band_need"))
defineProperty("ark_tune_need", globalPropertyi("an-24rv/ark/ark1_tune_need"))
defineProperty("ark_fine_tune_need", globalPropertyi("an-24rv/ark/ark1_fine_tune_need"))


defineProperty("button", globalPropertyi("an-24rv/ark/ark1_button"))
defineProperty("ark_mode", globalPropertyi("an-24rv/ark/ark1_mode"))
defineProperty("ark_band", globalPropertyi("an-24rv/ark/ark1_band"))
defineProperty("band_fix", globalPropertyi("an-24rv/ark/ark1_band_fix"))
defineProperty("ark_tune", globalPropertyi("an-24rv/ark/ark1_tune"))
defineProperty("tune_fix", globalPropertyi("an-24rv/ark/ark1_tune_fix"))
defineProperty("ark_fine_tune", globalPropertyi("an-24rv/ark/ark1_fine_tune"))
defineProperty("ant_sw", globalPropertyi("an-24rv/ark/ark1_ant_sw"))
defineProperty("cw_sw", globalPropertyi("an-24rv/ark/ark1_cw"))


-- power
defineProperty("bus27", globalPropertyf("an-24rv/power/bus_DC_27_volt_emerg"))
defineProperty("bus115", globalPropertyf("an-24rv/power/bus_AC_115_volt"))
defineProperty("ark_cc", globalPropertyf("an-24rv/ark/ark1_cc"))
...
-- result
defineProperty("res_angle", globalPropertyf("an-24rv/ark/ark1_angle"))
defineProperty("res_signal", globalPropertyf("an-24rv/ark/ark1_signal"))
...
function file_read()
	local filename
	if get(dev_num) == 0 then filename = panelDir .. "/an-24rv_ark1.ini" else filename = panelDir .. "/an-24rv_ark2.ini" end -- define file by device number
