...
createGlobalPropertyf("an-24rv/misc/ushdb_3_scale_angle", 0) -- поворот шкалы на УШДБ
createGlobalPropertyf("an-24rv/misc/ushdb_3_scale_dir", 0) -- направление поворота шкалы на УШДБ

defineProperty("ushdb_3_scale_angle", globalPropertyf("an-24rv/misc/ushdb_3_scale_angle")) -- поворот шкалы на УШДБ
defineProperty("ushdb_3_scale_dir", globalPropertyf("an-24rv/misc/ushdb_3_scale_dir")) -- поворот шкалы на УШДБ 
