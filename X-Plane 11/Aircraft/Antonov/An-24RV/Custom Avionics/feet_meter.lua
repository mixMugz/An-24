...
-- pressure value
defineProperty("pressure", globalPropertyf("an-24rv/gauges/feet_meter_press"))
...
-- electric
defineProperty("feet_meter_cc", globalPropertyf("an-24rv/gauges/feet_meter_cc")) -- gauge current consumption
