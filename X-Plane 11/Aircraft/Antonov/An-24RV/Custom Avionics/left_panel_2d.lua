...
defineProperty("ru19_ground_start_cap", globalPropertyi("an-24rv/start/ru19_ground_start_cap")) -- start on ground button cap
...
-- hydro
defineProperty("main_press_angle_2d", globalPropertyf("an-24rv/hydro/main_press_angle"))
defineProperty("emerg_press_angle_2d", globalPropertyf("an-24rv/hydro/emerg_press_angle"))
defineProperty("store_press_angle_2d", globalPropertyf("an-24rv/hydro/store_press_angle"))
defineProperty("left_press_angle_2d", globalPropertyf("an-24rv/hydro/left_press_angle"))
defineProperty("right_press_angle_2d", globalPropertyf("an-24rv/hydro/right_press_angle"))
defineProperty("hydro_quantity_angle_2d", globalPropertyf("an-24rv/hydro/hydro_quantity_angle"))
defineProperty("hydro_circle", globalPropertyi("an-24rv/hydro/hydro_circle"))  -- connect main and emergency feeds
-- ssos
defineProperty("ssos_test", globalPropertyi("an-24rv/gauges/ssos_test_sw")) 
defineProperty("ssos_sw", globalPropertyi("an-24rv/gauges/ssos_sw")) 
defineProperty("ssos_sw_cap", globalPropertyi("an-24rv/gauges/ssos_sw_cap")) 
defineProperty("ssos_power_lit", globalPropertyi("an-24rv/gauges/ssos_power_lit"))  -- ssos power lamp
-- ap
defineProperty("ap_mech_off", globalPropertyi("an-24rv/ap/ap_mech_off"))  -- ap mechanic off. o = mechanics works, 1 = mech off
defineProperty("ap_mech_off_cap", globalPropertyi("an-24rv/ap/ap_mech_off_cap"))  -- ap mechanic off cap
-- wiper
defineProperty("wiper_sw", globalPropertyi("sim/cockpit2/switches/wiper_speed"))  -- 0=off,1=25%speed,2=50%speed,3=100%speed.

defineProperty("left_subpanel", globalPropertyi("an-24rv/panels/left_subpanel"))
-- images
