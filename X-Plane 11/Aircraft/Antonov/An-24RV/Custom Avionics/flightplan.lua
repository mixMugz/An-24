...
defineProperty("adf1_meter", globalPropertyf("an-24rv/ark/ark1_signal"))
defineProperty("adf2_meter", globalPropertyf("an-24rv/ark/ark2_signal"))
defineProperty("ark1_mode", globalPropertyi("an-24rv/ark/ark1_mode"))
defineProperty("ark2_mode", globalPropertyi("an-24rv/ark/ark2_mode"))
defineProperty("ap_curse", globalPropertyf("an-24rv/ap/curse_zk")) -- curse for autopilot
defineProperty("gyro_curse", globalPropertyf("an-24rv/gauges/GPK_curse"))  -- gyro curse from GIK
...
defineProperty("DME_sw", globalPropertyi("an-24rv/gauges/dme_on"))  -- power switcher
...
defineProperty("ark_vor", globalPropertyf("an-24rv/gauges/ark_vor")) -- switcher ARK/VOR
...
defineProperty("adf1_freq", globalPropertyi("an-24rv/ark/ark1_need_freq"))
...
defineProperty("adf2_freq", globalPropertyi("an-24rv/ark/ark2_need_freq"))
defineProperty("nav_select", globalPropertyi("an-24rv/gauges/nav_select"))

defineProperty("datedays", globalPropertyi("sim/time/local_date_days"))


defineProperty("GPS_visible", globalPropertyi("an-24rv/set/hide_GPS"))
defineProperty("Garmin_visible", globalPropertyi("an-24rv/set/hide_Garmin"))
defineProperty("dst1", globalPropertyf("an-24rv/nas1/N_needle"))
defineProperty("dst2", globalPropertyf("an-24rv/nas1/E_needle"))
defineProperty("counter", globalPropertyf("an-24rv/nas1/counter"))
defineProperty("mode1", globalPropertyf("an-24rv/nas1/mode1"))
defineProperty("mode2", globalPropertyf("an-24rv/nas1/mode2"))
defineProperty("map_angle", globalPropertyf("an-24rv/nas1/map_angle"))
defineProperty("water", globalPropertyf("an-24rv/nas1/water"))
defineProperty("DISS", globalPropertyf("an-24rv/nas1/DISS"))
defineProperty("winddelta", globalPropertyf("an-24rv/nas1/windangle"))
defineProperty("windspeed", globalPropertyf("an-24rv/nas1/windspeed"))
defineProperty("rls_power_cc", globalPropertyf("an-24rv/rls/rls_power_cc"))
