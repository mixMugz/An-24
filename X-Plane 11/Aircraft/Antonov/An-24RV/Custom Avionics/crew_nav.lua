...
defineProperty("radioalt", globalPropertyf("an-24rv/gauges/radioalt"))
...
defineProperty("uprt1", globalPropertyf("an-24rv/misc/virt_rud1"))   
defineProperty("uprt2", globalPropertyf("an-24rv/misc/virt_rud2"))

defineProperty("radioalt_dh", globalPropertyi("an-24rv/gauges/radioalt_dh")) -- radio altitude is decision height
...
-- define all sounds
local speed_up = loadSample('sounds/crew/nav_speed_up.wav')
local speed_100 = loadSample('sounds/crew/nav_speed_100.wav')
local speed_120 = loadSample('sounds/crew/nav_speed_120.wav')
local speed_140 = loadSample('sounds/crew/nav_speed_140.wav')
local speed_160 = loadSample('sounds/crew/nav_speed_160.wav')
local speed_v1 = loadSample('sounds/crew/nav_v1.wav')
--local speed_200 = loadSample('sounds/crew/nav_speed_200.wav')
local speed_220 = loadSample('sounds/crew/nav_speed_220.wav')
--local speed_250 = loadSample('sounds/crew/nav_speed_250.wav')
local rotate = loadSample('sounds/crew/nav_rotate.wav')
local alt_safe = loadSample('sounds/crew/nav_safe.wav')
local alt_600 = loadSample('sounds/crew/nav_alt_600.wav')
local alt_500 = loadSample('sounds/crew/nav_alt_500.wav')
local alt_400 = loadSample('sounds/crew/nav_alt_400.wav')
local alt_300 = loadSample('sounds/crew/nav_alt_300.wav')
local alt_200 = loadSample('sounds/crew/nav_alt_200.wav')
local alt_100 = loadSample('sounds/crew/nav_alt_100.wav')
local alt_60 = loadSample('sounds/crew/nav_alt_60.wav')
local alt_50 = loadSample('sounds/crew/nav_alt_50.wav')
local alt_40 = loadSample('sounds/crew/nav_alt_40.wav')
local alt_30 = loadSample('sounds/crew/nav_alt_30.wav')
local alt_20 = loadSample('sounds/crew/nav_alt_20.wav')
local alt_10 = loadSample('sounds/crew/nav_alt_10.wav')
local alt_5 = loadSample('sounds/crew/nav_alt_5.wav')
local alt_4 = loadSample('sounds/crew/nav_alt_4.wav')
local alt_3 = loadSample('sounds/crew/nav_alt_3.wav')
local alt_2 = loadSample('sounds/crew/nav_alt_2.wav')
local alt_1 = loadSample('sounds/crew/nav_alt_1.wav')
local rating = loadSample('sounds/crew/nav_rating.wav')
