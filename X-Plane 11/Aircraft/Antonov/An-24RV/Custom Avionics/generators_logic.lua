...
defineProperty("stg1_volt", globalPropertyf("an-24rv/power/stg1_volt")) -- generator STG18 voltage. initial 28.5V
...
defineProperty("stg1_amp", globalPropertyf("an-24rv/power/stg1_amp")) -- generator current, initial 0A
...
defineProperty("stg1_on", globalPropertyi("an-24rv/power/stg1_on"))  -- generator connected to engine if 1 and dissconnected if 0
