...
defineProperty("adf1", globalPropertyf("an-24rv/ark/ark1_angle")) -- bearing to NDB
defineProperty("adf2", globalPropertyf("an-24rv/ark/ark2_angle"))

defineProperty("vor1", globalPropertyf("an-24rv/gauges/vor_1")) -- bearing to VOR
defineProperty("vor2", globalPropertyf("an-24rv/gauges/vor_2")) -- bearing to VOR
...
createGlobalPropertyf("an-24rv/misc/ushdb_2_scale_angle", 0) -- поворот шкалы на УШДБ
createGlobalPropertyf("an-24rv/misc/ushdb_2_scale_dir", 0) -- направление поворота шкалы на УШДБ

defineProperty("ushdb_1_scale_angle", globalPropertyf("an-24rv/misc/ushdb_1_scale_angle")) -- поворот шкалы на УШДБ
defineProperty("ushdb_1_scale_dir", globalPropertyf("an-24rv/misc/ushdb_1_scale_dir")) -- поворот шкалы на УШДБ
-- SmartCopilot
