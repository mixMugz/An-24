...
defineProperty("auasp_warn", globalPropertyi("an-24rv/gauges/auasp_warning"))  -- warning
defineProperty("auasp_button", globalPropertyi("an-24rv/gauges/auasp_button"))  -- check button
defineProperty("aoa_sensor_angle", globalPropertyf("an-24rv/misc/aoa_sensor_angle"))  -- angle of AOA sensor

-- power
defineProperty("auasp_sw", globalPropertyi("an-24rv/gauges/auasp_sw"))  -- power switcher
defineProperty("auasp_cc", globalPropertyf("an-24rv/gauges/auasp_cc"))  -- power current
